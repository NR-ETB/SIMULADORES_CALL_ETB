$(document).ready(function() {
    ...
    var tabsCount23 = parseInt(localStorage.getItem("tabsCount23")) || 0;
    tabsCount23++;
    localStorage.setItem("tabsCount23", tabsCount23);

    console.log("Nuevo valor de tabsCount23:", tabsCount23);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount23 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount23");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount23 === 1) {
                localStorage.setItem("tabsCount23", 0);
            }
            });
        }
});
