$(document).ready(function() {
    ...
    var tabsCount24 = parseInt(localStorage.getItem("tabsCount24")) || 0;
    tabsCount24++;
    localStorage.setItem("tabsCount24", tabsCount24);

    console.log("Nuevo valor de tabsCount24:", tabsCount24);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount24 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount24");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount24 === 1) {
                localStorage.setItem("tabsCount24", 0);
            }
            });
        }
});
