$(document).ready(function() {
    ...
    var tabsCount25 = parseInt(localStorage.getItem("tabsCount25")) || 0;
    tabsCount25++;
    localStorage.setItem("tabsCount25", tabsCount25);

    console.log("Nuevo valor de tabsCount25:", tabsCount25);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount25 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount25");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount25 === 1) {
                localStorage.setItem("tabsCount25", 0);
            }
            });
        }
});
