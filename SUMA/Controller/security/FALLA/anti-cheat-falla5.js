$(document).ready(function() {
    ...
    var tabsCount28 = parseInt(localStorage.getItem("tabsCount28")) || 0;
    tabsCount28++;
    localStorage.setItem("tabsCount28", tabsCount28);

    console.log("Nuevo valor de tabsCount28:", tabsCount28);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount28 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount28");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount28 === 1) {
                localStorage.setItem("tabsCount28", 0);
            }
            });
        }
});
