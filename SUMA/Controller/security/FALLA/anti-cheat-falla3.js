$(document).ready(function() {
    ...
    var tabsCount26 = parseInt(localStorage.getItem("tabsCount26")) || 0;
    tabsCount26++;
    localStorage.setItem("tabsCount26", tabsCount26);

    console.log("Nuevo valor de tabsCount26:", tabsCount26);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount26 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount26");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount26 === 1) {
                localStorage.setItem("tabsCount26", 0);
            }
            });
        }
});
