$(document).ready(function() {
    ...
    var tabsCount32 = parseInt(localStorage.getItem("tabsCount32")) || 0;
    tabsCount32++;
    localStorage.setItem("tabsCount32", tabsCount32);

    console.log("Nuevo valor de tabsCount32:", tabsCount32);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount32 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount32");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount32 === 1) {
                localStorage.setItem("tabsCount32", 0);
            }
            });
        }
});
