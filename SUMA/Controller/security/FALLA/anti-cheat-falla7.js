$(document).ready(function() {
    ...
    var tabsCount30 = parseInt(localStorage.getItem("tabsCount30")) || 0;
    tabsCount30++;
    localStorage.setItem("tabsCount30", tabsCount30);

    console.log("Nuevo valor de tabsCount30:", tabsCount30);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount30 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount30");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount30 === 1) {
                localStorage.setItem("tabsCount30", 0);
            }
            });
        }
});
