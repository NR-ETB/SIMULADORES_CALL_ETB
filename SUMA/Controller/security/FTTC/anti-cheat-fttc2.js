$(document).ready(function() {
    ...
    var tabsCount34 = parseInt(localStorage.getItem("tabsCount34")) || 0;
    tabsCount34++;
    localStorage.setItem("tabsCount34", tabsCount34);

    console.log("Nuevo valor de tabsCount34:", tabsCount34);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount34 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount34");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount34 === 1) {
                localStorage.setItem("tabsCount34", 0);
            }
            });
        }
});
