$(document).ready(function() {
    ...
    var tabsCount37 = parseInt(localStorage.getItem("tabsCount37")) || 0;
    tabsCount37++;
    localStorage.setItem("tabsCount37", tabsCount37);

    console.log("Nuevo valor de tabsCount37:", tabsCount37);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount37 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount37");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount37 === 1) {
                localStorage.setItem("tabsCount37", 0);
            }
            });
        }
});
