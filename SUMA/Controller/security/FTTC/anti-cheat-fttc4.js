$(document).ready(function() {
    ...
    var tabsCount36 = parseInt(localStorage.getItem("tabsCount36")) || 0;
    tabsCount36++;
    localStorage.setItem("tabsCount36", tabsCount36);

    console.log("Nuevo valor de tabsCount36:", tabsCount36);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount36 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount36");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount36 === 1) {
                localStorage.setItem("tabsCount36", 0);
            }
            });
        }
});
