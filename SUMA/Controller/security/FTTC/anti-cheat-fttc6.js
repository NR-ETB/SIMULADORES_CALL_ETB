$(document).ready(function() {
    ...
    var tabsCount38 = parseInt(localStorage.getItem("tabsCount38")) || 0;
    tabsCount38++;
    localStorage.setItem("tabsCount38", tabsCount38);

    console.log("Nuevo valor de tabsCount38:", tabsCount38);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount38 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount38");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount38 === 1) {
                localStorage.setItem("tabsCount38", 0);
            }
            });
        }
});
