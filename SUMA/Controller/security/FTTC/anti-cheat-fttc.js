$(document).ready(function() {
    ...
    var tabsCount33 = parseInt(localStorage.getItem("tabsCount33")) || 0;
    tabsCount33++;
    localStorage.setItem("tabsCount33", tabsCount33);

    console.log("Nuevo valor de tabsCount33:", tabsCount33);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount33 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount33");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount33 === 1) {
                localStorage.setItem("tabsCount33", 0);
            }
            });
        }
});
