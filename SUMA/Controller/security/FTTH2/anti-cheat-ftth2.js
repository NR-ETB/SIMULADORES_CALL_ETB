$(document).ready(function() {
    ...
    var tabsCount54 = parseInt(localStorage.getItem("tabsCount54")) || 0;
    tabsCount54++;
    localStorage.setItem("tabsCount54", tabsCount54);

    console.log("Nuevo valor de tabsCount54:", tabsCount54);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount54 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount54");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount54 === 1) {
                localStorage.setItem("tabsCount54", 0);
            }
            });
        }
});
