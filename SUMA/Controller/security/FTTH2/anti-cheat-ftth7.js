$(document).ready(function() {
    ...
    var tabsCount59 = parseInt(localStorage.getItem("tabsCount59")) || 0;
    tabsCount59++;
    localStorage.setItem("tabsCount59", tabsCount59);

    console.log("Nuevo valor de tabsCount59:", tabsCount59);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount59 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount59");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount59 === 1) {
                localStorage.setItem("tabsCount59", 0);
            }
            });
        }
});
