$(document).ready(function() {
    ...
    var tabsCount67 = parseInt(localStorage.getItem("tabsCount67")) || 0;
    tabsCount67++;
    localStorage.setItem("tabsCount67", tabsCount67);

    console.log("Nuevo valor de tabsCount67:", tabsCount67);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount67 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount67");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount67 === 1) {
                localStorage.setItem("tabsCount67", 0);
            }
            });
        }
});
