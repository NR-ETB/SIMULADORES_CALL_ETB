$(document).ready(function() {
    ...
    var tabsCount70 = parseInt(localStorage.getItem("tabsCount70")) || 0;
    tabsCount70++;
    localStorage.setItem("tabsCount70", tabsCount70);

    console.log("Nuevo valor de tabsCount70:", tabsCount70);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount70 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount70");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount70 === 1) {
                localStorage.setItem("tabsCount70", 0);
            }
            });
        }
});
