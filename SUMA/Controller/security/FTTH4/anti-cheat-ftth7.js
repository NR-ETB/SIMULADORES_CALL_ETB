$(document).ready(function() {
    ...
    var tabsCount73 = parseInt(localStorage.getItem("tabsCount73")) || 0;
    tabsCount73++;
    localStorage.setItem("tabsCount73", tabsCount73);

    console.log("Nuevo valor de tabsCount73:", tabsCount73);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount73 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount73");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount73 === 1) {
                localStorage.setItem("tabsCount73", 0);
            }
            });
        }
});
