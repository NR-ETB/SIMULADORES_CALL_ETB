$(document).ready(function() {
    ...
    var tabsCount68 = parseInt(localStorage.getItem("tabsCount68")) || 0;
    tabsCount68++;
    localStorage.setItem("tabsCount68", tabsCount68);

    console.log("Nuevo valor de tabsCount68:", tabsCount68);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount68 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount68");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount68 === 1) {
                localStorage.setItem("tabsCount68", 0);
            }
            });
        }
});
