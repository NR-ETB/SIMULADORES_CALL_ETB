$(document).ready(function() {
    ...
    var tabsCount71 = parseInt(localStorage.getItem("tabsCount71")) || 0;
    tabsCount71++;
    localStorage.setItem("tabsCount71", tabsCount71);

    console.log("Nuevo valor de tabsCount71:", tabsCount71);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount71 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount71");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount71 === 1) {
                localStorage.setItem("tabsCount71", 0);
            }
            });
        }
});
