$(document).ready(function() {
    ...
    var tabsCount72 = parseInt(localStorage.getItem("tabsCount72")) || 0;
    tabsCount72++;
    localStorage.setItem("tabsCount72", tabsCount72);

    console.log("Nuevo valor de tabsCount72:", tabsCount72);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount72 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount72");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount72 === 1) {
                localStorage.setItem("tabsCount72", 0);
            }
            });
        }
});
