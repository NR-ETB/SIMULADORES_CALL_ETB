$(document).ready(function() {
    ...
    var tabsCount69 = parseInt(localStorage.getItem("tabsCount69")) || 0;
    tabsCount69++;
    localStorage.setItem("tabsCount69", tabsCount69);

    console.log("Nuevo valor de tabsCount69:", tabsCount69);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount69 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount69");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount69 === 1) {
                localStorage.setItem("tabsCount69", 0);
            }
            });
        }
});
