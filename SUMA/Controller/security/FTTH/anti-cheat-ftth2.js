$(document).ready(function() {
    ...
    var tabsCount47 = parseInt(localStorage.getItem("tabsCount47")) || 0;
    tabsCount47++;
    localStorage.setItem("tabsCount47", tabsCount47);

    console.log("Nuevo valor de tabsCount47:", tabsCount47);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount47 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount47");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount47 === 1) {
                localStorage.setItem("tabsCount47", 0);
            }
            });
        }
});
