$(document).ready(function() {
    ...
    var tabsCount50 = parseInt(localStorage.getItem("tabsCount50")) || 0;
    tabsCount50++;
    localStorage.setItem("tabsCount50", tabsCount50);

    console.log("Nuevo valor de tabsCount50:", tabsCount50);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount50 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount50");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount50 === 1) {
                localStorage.setItem("tabsCount50", 0);
            }
            });
        }
});
