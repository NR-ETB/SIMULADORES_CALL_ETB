$(document).ready(function() {
    ...
    var tabsCount52 = parseInt(localStorage.getItem("tabsCount52")) || 0;
    tabsCount52++;
    localStorage.setItem("tabsCount52", tabsCount52);

    console.log("Nuevo valor de tabsCount52:", tabsCount52);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount52 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount52");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount52 === 1) {
                localStorage.setItem("tabsCount52", 0);
            }
            });
        }
});
