$(document).ready(function() {
    ...
    var tabsCount49 = parseInt(localStorage.getItem("tabsCount49")) || 0;
    tabsCount49++;
    localStorage.setItem("tabsCount49", tabsCount49);

    console.log("Nuevo valor de tabsCount49:", tabsCount49);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount49 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount49");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount49 === 1) {
                localStorage.setItem("tabsCount49", 0);
            }
            });
        }
});
