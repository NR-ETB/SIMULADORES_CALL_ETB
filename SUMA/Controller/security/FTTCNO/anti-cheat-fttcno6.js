$(document).ready(function() {
    ...
    var tabsCount44 = parseInt(localStorage.getItem("tabsCount44")) || 0;
    tabsCount44++;
    localStorage.setItem("tabsCount44", tabsCount44);

    console.log("Nuevo valor de tabsCount44:", tabsCount44);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount44 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount44");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount44 === 1) {
                localStorage.setItem("tabsCount44", 0);
            }
            });
        }
});
