$(document).ready(function() {
    ...
    var tabsCount42 = parseInt(localStorage.getItem("tabsCount42")) || 0;
    tabsCount42++;
    localStorage.setItem("tabsCount42", tabsCount42);

    console.log("Nuevo valor de tabsCount42:", tabsCount42);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount42 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount42");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount42 === 1) {
                localStorage.setItem("tabsCount42", 0);
            }
            });
        }
});
