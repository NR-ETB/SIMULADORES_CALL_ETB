$(document).ready(function() {
    ...
    var tabsCount43 = parseInt(localStorage.getItem("tabsCount43")) || 0;
    tabsCount43++;
    localStorage.setItem("tabsCount43", tabsCount43);

    console.log("Nuevo valor de tabsCount43:", tabsCount43);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount43 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount43");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount43 === 1) {
                localStorage.setItem("tabsCount43", 0);
            }
            });
        }
});
