$(document).ready(function() {
    ...
    var tabsCount41 = parseInt(localStorage.getItem("tabsCount41")) || 0;
    tabsCount41++;
    localStorage.setItem("tabsCount41", tabsCount41);

    console.log("Nuevo valor de tabsCount41:", tabsCount41);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount41 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount41");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount41 === 1) {
                localStorage.setItem("tabsCount41", 0);
            }
            });
        }
});
