$(document).ready(function() {
    ...
    var tabsCount39 = parseInt(localStorage.getItem("tabsCount39")) || 0;
    tabsCount39++;
    localStorage.setItem("tabsCount39", tabsCount39);

    console.log("Nuevo valor de tabsCount39:", tabsCount39);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount39 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount39");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount39 === 1) {
                localStorage.setItem("tabsCount39", 0);
            }
            });
        }
});
