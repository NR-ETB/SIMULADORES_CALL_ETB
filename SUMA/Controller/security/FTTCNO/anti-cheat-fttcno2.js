$(document).ready(function() {
    ...
    var tabsCount40 = parseInt(localStorage.getItem("tabsCount40")) || 0;
    tabsCount40++;
    localStorage.setItem("tabsCount40", tabsCount40);

    console.log("Nuevo valor de tabsCount40:", tabsCount40);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount40 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount40");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount40 === 1) {
                localStorage.setItem("tabsCount40", 0);
            }
            });
        }
});
