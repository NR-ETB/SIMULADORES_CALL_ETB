$(document).ready(function() {
    ...
    var tabsCount45 = parseInt(localStorage.getItem("tabsCount45")) || 0;
    tabsCount45++;
    localStorage.setItem("tabsCount45", tabsCount45);

    console.log("Nuevo valor de tabsCount45:", tabsCount45);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount45 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount45");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount45 === 1) {
                localStorage.setItem("tabsCount45", 0);
            }
            });
        }
});
