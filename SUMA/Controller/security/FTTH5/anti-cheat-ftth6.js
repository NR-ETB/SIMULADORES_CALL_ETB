$(document).ready(function() {
    ...
    var tabsCount79 = parseInt(localStorage.getItem("tabsCount79")) || 0;
    tabsCount79++;
    localStorage.setItem("tabsCount79", tabsCount79);

    console.log("Nuevo valor de tabsCount79:", tabsCount79);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount79 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount79");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount79 === 1) {
                localStorage.setItem("tabsCount79", 0);
            }
            });
        }
});
