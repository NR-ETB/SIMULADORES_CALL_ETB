$(document).ready(function() {
    ...
    var tabsCount74 = parseInt(localStorage.getItem("tabsCount74")) || 0;
    tabsCount74++;
    localStorage.setItem("tabsCount74", tabsCount74);

    console.log("Nuevo valor de tabsCount74:", tabsCount74);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount74 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount74");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount74 === 1) {
                localStorage.setItem("tabsCount74", 0);
            }
            });
        }
});
