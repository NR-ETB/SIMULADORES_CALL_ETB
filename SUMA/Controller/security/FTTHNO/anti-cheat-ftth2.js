$(document).ready(function() {
    ...
    var tabsCount82 = parseInt(localStorage.getItem("tabsCount82")) || 0;
    tabsCount82++;
    localStorage.setItem("tabsCount82", tabsCount82);

    console.log("Nuevo valor de tabsCount82:", tabsCount82);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount82 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount82");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount82 === 1) {
                localStorage.setItem("tabsCount82", 0);
            }
            });
        }
});
