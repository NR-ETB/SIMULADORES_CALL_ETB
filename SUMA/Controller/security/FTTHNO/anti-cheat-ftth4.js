$(document).ready(function() {
    ...
    var tabsCount84 = parseInt(localStorage.getItem("tabsCount84")) || 0;
    tabsCount84++;
    localStorage.setItem("tabsCount84", tabsCount84);

    console.log("Nuevo valor de tabsCount84:", tabsCount84);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount84 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount84");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount84 === 1) {
                localStorage.setItem("tabsCount84", 0);
            }
            });
        }
});
