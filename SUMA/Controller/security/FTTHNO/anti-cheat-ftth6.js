$(document).ready(function() {
    ...
    var tabsCount86 = parseInt(localStorage.getItem("tabsCount86")) || 0;
    tabsCount86++;
    localStorage.setItem("tabsCount86", tabsCount86);

    console.log("Nuevo valor de tabsCount86:", tabsCount86);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount86 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount86");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount86 === 1) {
                localStorage.setItem("tabsCount86", 0);
            }
            });
        }
});
