$(document).ready(function() {
    ...
    var tabsCount83 = parseInt(localStorage.getItem("tabsCount83")) || 0;
    tabsCount83++;
    localStorage.setItem("tabsCount83", tabsCount83);

    console.log("Nuevo valor de tabsCount83:", tabsCount83);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount83 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount83");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount83 === 1) {
                localStorage.setItem("tabsCount83", 0);
            }
            });
        }
});
