$(document).ready(function() {
    ...
    var tabsCount81 = parseInt(localStorage.getItem("tabsCount81")) || 0;
    tabsCount81++;
    localStorage.setItem("tabsCount81", tabsCount81);

    console.log("Nuevo valor de tabsCount81:", tabsCount81);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount81 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount81");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount81 === 1) {
                localStorage.setItem("tabsCount81", 0);
            }
            });
        }
});
