$(document).ready(function() {
    ...
    var tabsCount66 = parseInt(localStorage.getItem("tabsCount66")) || 0;
    tabsCount66++;
    localStorage.setItem("tabsCount66", tabsCount66);

    console.log("Nuevo valor de tabsCount66:", tabsCount66);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount66 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount66");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount66 === 1) {
                localStorage.setItem("tabsCount66", 0);
            }
            });
        }
});
