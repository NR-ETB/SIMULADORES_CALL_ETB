$(document).ready(function() {
    ...
    var tabsCount64 = parseInt(localStorage.getItem("tabsCount64")) || 0;
    tabsCount64++;
    localStorage.setItem("tabsCount64", tabsCount64);

    console.log("Nuevo valor de tabsCount64:", tabsCount64);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount64 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount64");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount64 === 1) {
                localStorage.setItem("tabsCount64", 0);
            }
            });
        }
});
