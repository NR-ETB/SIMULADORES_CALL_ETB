$(document).ready(function() {
    ...
    var tabsCount122 = parseInt(localStorage.getItem("tabsCount122")) || 0;
    tabsCount122++;
    localStorage.setItem("tabsCount122", tabsCount122);

    console.log("Nuevo valor de tabsCount122:", tabsCount122);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount122 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount122");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount122 === 1) {
                localStorage.setItem("tabsCount122", 0);
            }
            });
        }
});
