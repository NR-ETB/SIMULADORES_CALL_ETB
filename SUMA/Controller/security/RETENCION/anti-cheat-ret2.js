$(document).ready(function() {
    ...
    var tabsCount120 = parseInt(localStorage.getItem("tabsCount120")) || 0;
    tabsCount120++;
    localStorage.setItem("tabsCount120", tabsCount120);

    console.log("Nuevo valor de tabsCount120:", tabsCount120);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount120 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount120");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount120 === 1) {
                localStorage.setItem("tabsCount120", 0);
            }
            });
        }
});
