$(document).ready(function() {
    ...
    var tabsCount126 = parseInt(localStorage.getItem("tabsCount126")) || 0;
    tabsCount126++;
    localStorage.setItem("tabsCount126", tabsCount126);

    console.log("Nuevo valor de tabsCount126:", tabsCount126);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount126 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount126");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount126 === 1) {
                localStorage.setItem("tabsCount126", 0);
            }
            });
        }
});
