$(document).ready(function() {
    ...
    var tabsCount127 = parseInt(localStorage.getItem("tabsCount127")) || 0;
    tabsCount127++;
    localStorage.setItem("tabsCount127", tabsCount127);

    console.log("Nuevo valor de tabsCount127:", tabsCount127);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount127 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount127");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount127 === 1) {
                localStorage.setItem("tabsCount127", 0);
            }
            });
        }
});
