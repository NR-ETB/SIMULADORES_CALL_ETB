$(document).ready(function() {
    ...
    var tabsCount135 = parseInt(localStorage.getItem("tabsCount135")) || 0;
    tabsCount135++;
    localStorage.setItem("tabsCount135", tabsCount135);

    console.log("Nuevo valor de tabsCount135:", tabsCount135);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount135 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount135");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount135 === 1) {
                localStorage.setItem("tabsCount135", 0);
            }
            });
        }
});
