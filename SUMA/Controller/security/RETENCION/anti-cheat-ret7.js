$(document).ready(function() {
    ...
    var tabsCount125 = parseInt(localStorage.getItem("tabsCount125")) || 0;
    tabsCount125++;
    localStorage.setItem("tabsCount125", tabsCount125);

    console.log("Nuevo valor de tabsCount125:", tabsCount125);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount125 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount125");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount125 === 1) {
                localStorage.setItem("tabsCount125", 0);
            }
            });
        }
});
