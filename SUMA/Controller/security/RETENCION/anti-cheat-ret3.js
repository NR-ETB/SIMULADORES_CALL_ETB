$(document).ready(function() {
    ...
    var tabsCount121 = parseInt(localStorage.getItem("tabsCount121")) || 0;
    tabsCount121++;
    localStorage.setItem("tabsCount121", tabsCount121);

    console.log("Nuevo valor de tabsCount121:", tabsCount121);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount121 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount121");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount121 === 1) {
                localStorage.setItem("tabsCount121", 0);
            }
            });
        }
});
