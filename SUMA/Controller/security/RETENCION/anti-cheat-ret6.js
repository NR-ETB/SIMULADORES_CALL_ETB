$(document).ready(function() {
    ...
    var tabsCount124 = parseInt(localStorage.getItem("tabsCount124")) || 0;
    tabsCount124++;
    localStorage.setItem("tabsCount124", tabsCount124);

    console.log("Nuevo valor de tabsCount124:", tabsCount124);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount124 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount124");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount124 === 1) {
                localStorage.setItem("tabsCount124", 0);
            }
            });
        }
});
