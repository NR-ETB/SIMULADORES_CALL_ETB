$(document).ready(function() {
    ...
    var tabsCount132 = parseInt(localStorage.getItem("tabsCount132")) || 0;
    tabsCount132++;
    localStorage.setItem("tabsCount132", tabsCount132);

    console.log("Nuevo valor de tabsCount132:", tabsCount132);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount132 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount132");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount132 === 1) {
                localStorage.setItem("tabsCount132", 0);
            }
            });
        }
});
