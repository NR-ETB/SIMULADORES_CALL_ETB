$(document).ready(function() {
    ...
    var tabsCount136 = parseInt(localStorage.getItem("tabsCount136")) || 0;
    tabsCount136++;
    localStorage.setItem("tabsCount136", tabsCount136);

    console.log("Nuevo valor de tabsCount136:", tabsCount136);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount136 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount136");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount136 === 1) {
                localStorage.setItem("tabsCount136", 0);
            }
            });
        }
});
