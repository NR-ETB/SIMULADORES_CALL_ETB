$(document).ready(function() {
    ...
    var tabsCount92 = parseInt(localStorage.getItem("tabsCount92")) || 0;
    tabsCount92++;
    localStorage.setItem("tabsCount92", tabsCount92);

    console.log("Nuevo valor de tabsCount92:", tabsCount92);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount92 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount92");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount92 === 1) {
                localStorage.setItem("tabsCount92", 0);
            }
            });
        }
});
