$(document).ready(function() {
    ...
    var tabsCount103 = parseInt(localStorage.getItem("tabsCount103")) || 0;
    tabsCount103++;
    localStorage.setItem("tabsCount103", tabsCount103);

    console.log("Nuevo valor de tabsCount103:", tabsCount103);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount103 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount103");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount103 === 1) {
                localStorage.setItem("tabsCount103", 0);
            }
            });
        }
});
