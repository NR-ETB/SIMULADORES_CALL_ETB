$(document).ready(function() {
    ...
    var tabsCount102 = parseInt(localStorage.getItem("tabsCount102")) || 0;
    tabsCount102++;
    localStorage.setItem("tabsCount102", tabsCount102);

    console.log("Nuevo valor de tabsCount102:", tabsCount102);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount102 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount102");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount102 === 1) {
                localStorage.setItem("tabsCount102", 0);
            }
            });
        }
});
