$(document).ready(function() {
    ...
    var tabsCount96 = parseInt(localStorage.getItem("tabsCount96")) || 0;
    tabsCount96++;
    localStorage.setItem("tabsCount96", tabsCount96);

    console.log("Nuevo valor de tabsCount96:", tabsCount96);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount96 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount96");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount96 === 1) {
                localStorage.setItem("tabsCount96", 0);
            }
            });
        }
});
