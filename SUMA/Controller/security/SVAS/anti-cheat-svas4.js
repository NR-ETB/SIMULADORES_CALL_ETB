$(document).ready(function() {
    ...
    var tabsCount95 = parseInt(localStorage.getItem("tabsCount95")) || 0;
    tabsCount95++;
    localStorage.setItem("tabsCount95", tabsCount95);

    console.log("Nuevo valor de tabsCount95:", tabsCount95);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount95 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount95");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount95 === 1) {
                localStorage.setItem("tabsCount95", 0);
            }
            });
        }
});
