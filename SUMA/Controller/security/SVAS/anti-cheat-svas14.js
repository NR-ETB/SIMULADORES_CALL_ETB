$(document).ready(function() {
    ...
    var tabsCount104 = parseInt(localStorage.getItem("tabsCount104")) || 0;
    tabsCount104++;
    localStorage.setItem("tabsCount104", tabsCount104);

    console.log("Nuevo valor de tabsCount104:", tabsCount104);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount104 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount104");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount104 === 1) {
                localStorage.setItem("tabsCount104", 0);
            }
            });
        }
});
