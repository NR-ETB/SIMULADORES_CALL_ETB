$(document).ready(function() {
    ...
    var tabsCount107 = parseInt(localStorage.getItem("tabsCount107")) || 0;
    tabsCount107++;
    localStorage.setItem("tabsCount107", tabsCount107);

    console.log("Nuevo valor de tabsCount107:", tabsCount107);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount107 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount107");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount107 === 1) {
                localStorage.setItem("tabsCount107", 0);
            }
            });
        }
});
