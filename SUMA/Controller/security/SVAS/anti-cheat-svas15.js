$(document).ready(function() {
    ...
    var tabsCount105 = parseInt(localStorage.getItem("tabsCount105")) || 0;
    tabsCount105++;
    localStorage.setItem("tabsCount105", tabsCount105);

    console.log("Nuevo valor de tabsCount105:", tabsCount105);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount105 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount105");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount105 === 1) {
                localStorage.setItem("tabsCount105", 0);
            }
            });
        }
});
