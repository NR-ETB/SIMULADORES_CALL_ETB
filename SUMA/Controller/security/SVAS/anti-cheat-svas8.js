$(document).ready(function() {
    ...
    var tabsCount99 = parseInt(localStorage.getItem("tabsCount99")) || 0;
    tabsCount99++;
    localStorage.setItem("tabsCount99", tabsCount99);

    console.log("Nuevo valor de tabsCount99:", tabsCount99);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount99 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount99");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount99 === 1) {
                localStorage.setItem("tabsCount99", 0);
            }
            });
        }
});
