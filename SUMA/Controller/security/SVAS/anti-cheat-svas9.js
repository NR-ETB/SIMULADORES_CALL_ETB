$(document).ready(function() {
    ...
    var tabsCount100 = parseInt(localStorage.getItem("tabsCount100")) || 0;
    tabsCount100++;
    localStorage.setItem("tabsCount100", tabsCount100);

    console.log("Nuevo valor de tabsCount100:", tabsCount100);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount100 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount100");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount100 === 1) {
                localStorage.setItem("tabsCount100", 0);
            }
            });
        }
});
