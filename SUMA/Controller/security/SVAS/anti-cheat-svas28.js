$(document).ready(function() {
    ...
    var tabsCount118 = parseInt(localStorage.getItem("tabsCount118")) || 0;
    tabsCount118++;
    localStorage.setItem("tabsCount118", tabsCount118);

    console.log("Nuevo valor de tabsCount118:", tabsCount118);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount118 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount118");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount118 === 1) {
                localStorage.setItem("tabsCount118", 0);
            }
            });
        }
});
