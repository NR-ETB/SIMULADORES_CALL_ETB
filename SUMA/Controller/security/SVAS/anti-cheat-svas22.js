$(document).ready(function() {
    ...
    var tabsCount112 = parseInt(localStorage.getItem("tabsCount112")) || 0;
    tabsCount112++;
    localStorage.setItem("tabsCount112", tabsCount112);

    console.log("Nuevo valor de tabsCount112:", tabsCount112);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount112 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount112");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount112 === 1) {
                localStorage.setItem("tabsCount112", 0);
            }
            });
        }
});
