$(document).ready(function() {
    ...
    var tabsCount93 = parseInt(localStorage.getItem("tabsCount93")) || 0;
    tabsCount93++;
    localStorage.setItem("tabsCount93", tabsCount93);

    console.log("Nuevo valor de tabsCount93:", tabsCount93);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount93 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount93");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount93 === 1) {
                localStorage.setItem("tabsCount93", 0);
            }
            });
        }
});
