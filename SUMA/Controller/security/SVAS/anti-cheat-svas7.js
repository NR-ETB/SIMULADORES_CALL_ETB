$(document).ready(function() {
    ...
    var tabsCount98 = parseInt(localStorage.getItem("tabsCount98")) || 0;
    tabsCount98++;
    localStorage.setItem("tabsCount98", tabsCount98);

    console.log("Nuevo valor de tabsCount98:", tabsCount98);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount98 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount98");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount98 === 1) {
                localStorage.setItem("tabsCount98", 0);
            }
            });
        }
});
