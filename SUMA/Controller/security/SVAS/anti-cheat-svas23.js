$(document).ready(function() {
    ...
    var tabsCount113 = parseInt(localStorage.getItem("tabsCount113")) || 0;
    tabsCount113++;
    localStorage.setItem("tabsCount113", tabsCount113);

    console.log("Nuevo valor de tabsCount113:", tabsCount113);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount113 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount113");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount113 === 1) {
                localStorage.setItem("tabsCount113", 0);
            }
            });
        }
});
