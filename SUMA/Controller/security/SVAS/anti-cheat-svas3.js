$(document).ready(function() {
    ...
    var tabsCount94 = parseInt(localStorage.getItem("tabsCount94")) || 0;
    tabsCount94++;
    localStorage.setItem("tabsCount94", tabsCount94);

    console.log("Nuevo valor de tabsCount94:", tabsCount94);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount94 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount94");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount94 === 1) {
                localStorage.setItem("tabsCount94", 0);
            }
            });
        }
});
