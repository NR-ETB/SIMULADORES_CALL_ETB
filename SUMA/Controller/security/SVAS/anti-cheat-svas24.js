$(document).ready(function() {
    ...
    var tabsCount114 = parseInt(localStorage.getItem("tabsCount114")) || 0;
    tabsCount114++;
    localStorage.setItem("tabsCount114", tabsCount114);

    console.log("Nuevo valor de tabsCount114:", tabsCount114);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount114 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount114");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount114 === 1) {
                localStorage.setItem("tabsCount114", 0);
            }
            });
        }
});
