$(document).ready(function() {
    ...
    var tabsCount101 = parseInt(localStorage.getItem("tabsCount101")) || 0;
    tabsCount101++;
    localStorage.setItem("tabsCount101", tabsCount101);

    console.log("Nuevo valor de tabsCount101:", tabsCount101);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount101 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount101");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount101 === 1) {
                localStorage.setItem("tabsCount101", 0);
            }
            });
        }
});
