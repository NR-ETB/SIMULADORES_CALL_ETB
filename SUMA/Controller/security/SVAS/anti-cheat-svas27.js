$(document).ready(function() {
    ...
    var tabsCount117 = parseInt(localStorage.getItem("tabsCount117")) || 0;
    tabsCount117++;
    localStorage.setItem("tabsCount117", tabsCount117);

    console.log("Nuevo valor de tabsCount117:", tabsCount117);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount117 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount117");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount117 === 1) {
                localStorage.setItem("tabsCount117", 0);
            }
            });
        }
});
