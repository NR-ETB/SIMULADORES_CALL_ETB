$(document).ready(function() {
    ...
    var tabsCount106 = parseInt(localStorage.getItem("tabsCount106")) || 0;
    tabsCount106++;
    localStorage.setItem("tabsCount106", tabsCount106);

    console.log("Nuevo valor de tabsCount106:", tabsCount106);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount106 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount106");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount106 === 1) {
                localStorage.setItem("tabsCount106", 0);
            }
            });
        }
});
