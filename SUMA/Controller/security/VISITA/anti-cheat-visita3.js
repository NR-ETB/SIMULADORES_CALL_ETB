$(document).ready(function() {
    ...
    var tabsCount90 = parseInt(localStorage.getItem("tabsCount90")) || 0;
    tabsCount90++;
    localStorage.setItem("tabsCount90", tabsCount90);

    console.log("Nuevo valor de tabsCount90:", tabsCount90);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount90 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount90");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount90 === 1) {
                localStorage.setItem("tabsCount90", 0);
            }
            });
        }
});
