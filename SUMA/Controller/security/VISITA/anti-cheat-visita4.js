$(document).ready(function() {
    ...
    var tabsCount91 = parseInt(localStorage.getItem("tabsCount91")) || 0;
    tabsCount91++;
    localStorage.setItem("tabsCount91", tabsCount91);

    console.log("Nuevo valor de tabsCount91:", tabsCount91);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount91 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount91");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount91 === 1) {
                localStorage.setItem("tabsCount91", 0);
            }
            });
        }
});
