$(document).ready(function() {
    ...
    var tabsCount89 = parseInt(localStorage.getItem("tabsCount89")) || 0;
    tabsCount89++;
    localStorage.setItem("tabsCount89", tabsCount89);

    console.log("Nuevo valor de tabsCount89:", tabsCount89);
    ...
    var maxTabs = 1; // Máximo número de pestañas permitidas
        ...
        if (tabsCount89 > maxTabs) {
            ...
            window.addEventListener('unload', function() {
                ...
                localStorage.removeItem("tabsCount89");

            // Reiniciar el contador si no hay otras pestañas abiertas
            if (tabsCount89 === 1) {
                localStorage.setItem("tabsCount89", 0);
            }
            });
        }
});
