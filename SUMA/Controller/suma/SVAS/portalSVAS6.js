    ...
    if (docType !== '0' && numDoc.trim() !== '' || numCox.trim() !== '' || numCue.trim() !== '') {
        ...
        if (docType === '1' && numDoc === '1000958632' || numCox === '6012065894' || numCue === '5555') {
            ...
            setTimeout(() => {
                ...
                habladorText('Para realizar la validación, ingresa por medio del botón REGISTRAR')
            }, 4000); 
