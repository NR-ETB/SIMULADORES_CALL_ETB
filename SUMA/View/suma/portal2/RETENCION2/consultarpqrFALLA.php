...
<div class="usuario" style="margin-left: 35px;">
            ...
            <table class="table-general table-sopor" style="width: 400px; position: relative; bottom: 10px; margin: 20px 0 0 60px;">
                ...
                <tr class="row-bl">
                    ...
                    <td>2222</td>
                    <td>6012045786</td>
                    <td><img src="../../../images/images-suma/folder.png" style="position: relative; left: 60px; width: 20px; height: 20px;" onclick="location.href='./pqrFALLA.php'"></td>
                    <td></td>
                </tr>
            </table>
            </div>
    ...
    <script src="../../../../Controller/security/FALLA/anti-cheat-falla.js"></script>
