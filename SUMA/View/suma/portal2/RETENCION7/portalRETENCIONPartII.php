                ...
                <div class="con-pasos sw-main sw-theme-arrows" id="smartwizard">
                    <ul class="nav nav-tabs step-anchor">
                        ...
                        <li class="nav-item nav-item-alert"><a class="nav-link">
                            <img src="../../../images/speaker.png" alt="parlante-audio-etb" class="img-audio" id="img-list-paso-a" onclick="alertAudio('au-list-rete2', 'img-list-paso-a')" style="margin-left: 20px;">
                            <audio id="au-list-rete2" controls class="audio" style="display: none;">
                                <source type="audio/wav" src="../../../../Model/audioSuma/reten/reten8.mp3">
                            </audio>
                        </a></li>   
                    </ul>
                </div>
