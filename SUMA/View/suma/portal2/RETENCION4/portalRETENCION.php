...
<body>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="dates(),habladorText('Cliente: HERNAN CAPEIRO <br> Numero de Documento: CC 1000634251 <br> Numero de Conexion: 6017829304 <br> Cuenta Facturacion: 7777');">ACEPTAR</button>
                </div>
            </div>
            </div>
    </div>
                            ...
                            <div style="position: relative; top: 40px;" id="ocul1">
                                ...
                                <div class="table-solui" style="bottom: 110px; position: relative; left: 100px;" id="">
                                        <table class="table-general table-sopor" style="width: 900px;">
                                            ...
                                            <tr class="row-bl" id="ayu29" style="display: none;">
                                                <td colspan="12" style="text-align: center;"><a href="../../../../Model/documents/PlantillasRet.pdf" target="_blank" style="text-decoration: none; color: var(--orange-etb);">Plantillas para Retenciones</a></td>
                                            </tr>
                                    </table>
                                </div>
    ...
    <script src="../../../../Controller/security/RETENCION/anti-cheat-ret11.js"></script>    
