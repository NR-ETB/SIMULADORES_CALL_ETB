...
<body>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="dates(),habladorText('Para filtrar a nuestro cliente en cuestion puedes utilizar diferentes datos para esto, en este escenario usaremos unicamente el NUMERO DE ORDEN: RF-003575869');">ACEPTAR</button>
                </div>
            </div>
            </div>
    </div>
