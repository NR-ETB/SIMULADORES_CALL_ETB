...
<body>
                                ...
                                <div class="con-table2">
                                    <table class="table-general table-sopor table-produc">
                                        ...
                                        <tr id="abi3" onclick="tabac5(),tabac6();">
                                            ...
                                            <td>INTERNET</td>
                                            <td>FALLA WIFI</td>
                                            <td>NINGUN DISPOSITIVO WIFI -F</td>
                                            <td>ABIERTO</td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            <p>Has finalizado con exito el escenario NINGUN DISPOSITIVO WIFI-F (FTTH) del Simulador SUMA, recuerda que siempre esta a tu disposicion y cuentas con intentos ilimitados :)</p>
            </div>
            <div class="modal-footer">
