...
<head>
    ...
    <link rel="stylesheet" href="../../css/reportarfalla-2.css">
...
<body>
                                        ...
                                        <div class="soportepn">
                                            ...
                                            <div class="items-info items-sopor" style="margin-top: 20px;">
                                                ...
                                                <div class="body-items-inf">
                                                    <div class="contet" id="con-sopo-info" style="height: 200px;">
                                                        <label style="grid-column: 1/4;">Teléfono</label>
                                                        <p  style="grid-column: 1/4;">6012014935</p>

                                                        <label for=""  style="grid-column: 2/4; position: relative; bottom: 70px;">Nombre Suscriptor</label>
                                                        <p id="nombre-ti" style="grid-column: 2/4; position: relative; bottom: 70px;">CLAID MUSS</p>

                                                        <label for="" style="grid-column: 3/4; position: relative; bottom: 140px;">Estado Cuenta facturación</label>
                                                        <p style="grid-column: 3/4; position: relative; bottom: 140px;">Activo</p>

                                                        <label for="" style="grid-column: 4/4; position: relative; bottom: 175px; margin-left: 46px;">Estado Cuenta Servicio</label>
                                                        <p style="grid-column: 4/4; position: relative; bottom: 175px; margin-left: 46px;">Activo</p>

                                                        <label for="" class="sub-info-so" style="grid-column: 1/4; position: relative; bottom: 170px;">INC Falla Masiva</label>
                                                        <p  class="sub-info-so"  style="grid-column: 1/4; position: relative; bottom: 170px;">Dato no existente</p>

                                                        <label for="" class="sub-info-so" style="grid-column: 2/4; position: relative; bottom: 240px;">Fecha Creacion FM</label>
                                                        <p  class="sub-info-so" style="grid-column: 2/4; position: relative; bottom: 240px;">Dato no existente</p>

                                                        <label for="" class="sub-info-so" style="grid-column: 3/4; position: relative; bottom: 310px;">TES</label>
                                                        <p  class="sub-info-so" style="grid-column: 3/4; position: relative; bottom: 310px;">Dato no existente</p>

                                                        <label for="" class="sub-info-so" style="grid-column: 4/4; position: relative; bottom: 350px; margin-left: 45px;">Cantidad INC Relacionados</label>
                                                        <p  class="sub-info-so" style="grid-column: 4/4; position: relative; bottom: 350px; margin-left: 45px;">Dato no existente</p>

                                                        <label for="" class="sub-info-so" style="grid-column: 1/4; position: relative; bottom: 340px;">Grupo Asignado INC Falla Masiva</label>
                                                        <p  class="sub-info-so" style="grid-column: 1/4; position: relative; bottom: 340px;">Dato no existente</p>

                                                        <label for="" class="sub-info-so" style="grid-column: 2/4; position: relative; bottom: 410px; margin-left: 105px">Tipo de Falla</label>
                                                        <p  class="sub-info-so" style="grid-column: 2/4;"></p>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="contet con-tree-colms" id="con-sopo-prueba-ra">
                                                        <div class="con-table">
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Potencia</td>
                                                                        <td id="sen1" class="info__sem">#NOTFOUND<div class="semaforo semaforo-error"></div></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        ...
                                                        <div class="con-table" style="grid-column: 1/2;">
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    <tr class="row-bl">
                                                                        <td>IP ACS</td>
                                                                        <td class="info__sem">http://100.65.101.96:7547 <div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>ESTADO ACS</td>
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    <tr class="row-bl">
                                                                        ...
                                                                        <td>50M</td>
                                                                        <td class="info__sem">50M <div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                                    <tr>
                                                        ...
                                                        <div class="con-table" style="grid-column: 3/4; grid-row:1/2">
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    <tr class="row-bl">
                                                                        <td>Estado Línea Equipo Voz</td>
                                                                        <td>Normal, Sin Bloqueos</td>
                                                                        <td class="info_sem">Activo <div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                            ...
                                            <div class="items-info items-sopor">
                                                <div class="cabecera">
                                                    <h5 onclick="itemInfoSoporte('con-sopo-telefo')">
                                                        <img src="../../../images/rule.svg" alt="" class="menus-cabecera">
                                                        LINEA TELEFONICA DE ARRANQUE</h5>
                                                    ...
                                                    <div class="contet hide-body con-tree-colms" id="con-sopo-telefo">
                                                        ...
                                                        <div class="con-table">
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    <tr class="row-bl">
                                                                        <td>Categoria</td>
                                                                        <td>Local + LDN + LDI + CEL + 01901 + CODIGO SECRETO</td>
                                                                        <td class="dell-sem">Local + LDN + LDI + CEL + 01901 + CODIGO SECRETO <div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Estado No Tel</td>
                                                                        <td>Activo</td>
                                                                    ...
                                                                    <tr class="row-bl">
                                                                        <td>Numero Tel Programado en IPPHONE</td>
                                                                        <td>+576017647268</td>
                                                                        <td class="dell-sem" style="display: none;" id="ip1_1">+576017647268 <div class="semaforo semaforo-co" id="semaforo-tel-modem"></div></td>
                                                                        <td class="dell-sem" id="ip2_1">-<div class="semaforo semaforo-error" id="semaforo-tel-modem"></div></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Registro linea</td>
                                                                        <td>-</td>
                                                                        <td class="dell-sem" style="display: none;" id="ip1_2">Up <div class="semaforo semaforo-co"></div></td>
                                                                        <td class="dell-sem" id="ip2_2">-<div class="semaforo semaforo-error" id="semaforo-tel-modem"></div></td>
                                                                    </tr>
                                                                    <tr class="row-bl">
                                                                        <td>MAC</td>
                                                                        <td>805EC98A4G45</td>
                                                                    ...
                                                                    <tr>
                                                                        <td>Tipo de repique</td>
                                                                        <td>-</td>
                                                                        <td class="dell-sem">#NOTFOUND <div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    <tr class="row-bl">
                                                                        ...
                                                                        <td id="ip6_1" class="dell-sem" style="min-width: 250px;">
                                                                            Coferencia entre Tres;
                                                                            ...
                                                                            Marcación Redial
                                                                        <div class="semaforo semaforo-temp" id="semaforo-serv-secundarios"></div>
                                                                        </td>
                                                                        <td id="ip5_1" class="dell-sem" style="min-width: 250px; display: none;">
                                                                            Coferencia entre Tres;
                                                        ...
                                                        <div class="items-actions-soporte items__actions_four">
                                                            ...
                                                            <div class="dropdrown-act drowndown__fon" id="dropdrown-act-linea-t">
                                                                <label for="" class="label-disa" onclick="habladorText('Esta función no esta disponible para esta orden')">Normalizar Servicios Suplementarios</label>
                                                                ...
                                                                <label for="" onclick="habladorText('Normalizará el número telefonico que se encuentra configurado según el IPPHONE')" id="btn-norm-tel-modem">Normalizar No. Tel Configurado en IPPHONE</label>
                                            ...
                                            <div class="items-info items-sopor">
                                                ...
                                                <div class="body-items-inf">
                                                    <div class="contet hide-body con-tree-colms" id="con-sopo-telefo">
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="row-bl">
                                                                        <td>Numero Tel Programado en IPPHONE</td>
                                                                        <td>+576017647268</td>
                                                                        <td class="dell-sem" style="display: none;" id="ip3_1">+576017647268 <div class="semaforo semaforo-co" id="semaforo-tel-modem"></div></td>
                                                                        <td class="dell-sem" id="ip4_1">-<div class="semaforo semaforo-error" id="semaforo-tel-modem"></div></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Registro linea</td>
                                                                        <td>-</td>
                                                                        <td class="dell-sem" style="display: none;" id="ip3_2">Up <div class="semaforo semaforo-co"></div></td>
                                                                        <td class="dell-sem" id="ip4_2">-<div class="semaforo semaforo-error" id="semaforo-tel-modem"></div></td>
                                                                    </tr>                                                                    
                                                                    <tr class="row-bl">
                                                                        <td>MAC</td>
                                                                        <td>805EC98A4G45</td>
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    <tr class="row-bl">
                                                                        ...
                                                                        <td id="ip6_2" class="dell-sem" style="min-width: 250px;">
                                                                            Coferencia entre Tres;
                                                                        ...
                                                                        <td id="ip5_2" class="dell-sem" style="min-width: 250px; display: none;">
                                                                            Coferencia entre Tres;
                                                        ...
                                                        <div class="items-actions-soporte items__actions_four">
                                                            <button style="background: #FF5E00;" onclick="action_linea_t2();">Acciones <i class="fa-solid fa-sort-down" style="color: #ffffff;"></i></button>
                                                            <img src="../../../images/speaker2.png" alt="parlante-audio-etb" class="img-audio" id="img_act_lt_sf" onclick="alertAudio('au_act_lt_sf', 'img_act_lt_sf', 1, 8)">
                                                            <audio id="au_act_lt_sf" controls class="audio" style="display: none;">
                                                                <source type="audio/wav" src="../../../../Model/audioSuma/audio/soporte/au_act_lt_sf.mp3">
                                                            </audio>
                                                            <div class="dropdrown-act drowndown__fon" id="dropdrown-act-linea-t2">
                                                                <label for="" class="label-disa" onclick="habladorText('Esta función no esta disponible para esta orden')">Normalizar Servicios Suplementarios</label>
                                                                <label for="" class="label-disa" onclick="habladorText('Esta función no esta disponible para esta orden')">Normalizar CategorÃa Cliente</label>
                                                                <label for="" onclick="ipphone(),ipphone2(),modalExitoSoporte('NORMALIZAR_LINEA_SIP', false, false),habladorText('Normalizará el número telefonico que se encuentra configurado según el IPPHONE')" id="btn-norm-tel-modem">Normalizar No. Tel Configurado en IPPHONE</label>
                                                                <label for="" onclick="modalExitoSoporte('NORMALIZAR_LINEA_SIP', false, false), habladorText('Esta acción reiniciará el código secreto, para esto es necesario que ingrese el nuevo código en el formulario actual')">Reset CÃ³digo Secreto</label>
                                                                <label for="" class="label-disa" onclick="habladorText('Esta función no esta disponible para esta orden')">Normalizar la Linea Telefónica con bloqueo</label>
                                                                <label for="" onclick="modalExitoSoporte('NORMALIZAR_LINEA_SIP', false, false), habladorText('Esto ejecutará un proceso interno, Normalizará todos los servicios ACS, por consiguiente todos los semaforos serán refrescados.')">Reaprovisionar Servicio - ACS</label>
                                                            </div>
                                                            ...
                                                            <div class="dropdrown-act" id="dropdrown-act-consulta2">
                                                                <label for="" id="btn-transferencia" onclick="habladorText('Proporciona información sobre el número de teléfono')">TRANSFERENCIA INMEDIATA</label>
                                                            </div>
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    <tr class="row-bl">
                                                                        <td>Velocidad Bajada</td>
                                                                        <td>50M</td>
                                                                        <td class="dell-sem">50M<div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                    ...
                                                    <div class="contet hide-body con-tree-colms" id="con-sopo-ajustes-wifi">
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="dell-sem"><span id="Nombre-red-ont-so">SON</span> <div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                        ...
                                                        <div class="items-actions-soporte items__actions_four" style="border-top: 0px;">
                                                            ...
                                                            <div class="dropdrown-act" id="dropdrown-act-consulta-ont">
                                                                ...
                                                                <label for="" onclick="inter6(), habladorText('Permite realizar PING en la red LAN del Cliente, todo esto por medio de la consola del equipo. <br> Ingresa la IP 192.168.0.3 en el campo correspondiente, para poder continuar')">PING LAN CLIENTE</label>
                                                                <label for="">LAN</label>
                                                                <label for="">WAN</label>
                                                                ...
                                                                <table class="table-general table-sopor">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="dell-sem">SON 5.0<div class="semaforo semaforo-co"></div></td>
                                                                        </tr>
                                                                        <tr class="row-bl">
    ...
    <script src="../../../../Controller/security/FTTH5/anti-cheat-ftth3.js"></script>
