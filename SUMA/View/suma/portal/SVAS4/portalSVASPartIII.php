...
<body>
                           ...
                           <div class="table-product" id="con-sopo-inter">
                                <div class="con-table">
                                    <table class="table-general table-sopor table-produc">
                                        ...
                                        <tbody onclick="tabac1(),tabac2(),habladorText('Para realizar la gestion, primero deberas dirigirte al apartado Tramites Fija, en la barra lateral izquiera, acto seguido selecciona la opcion Cambio de Plan (PRCH)');">
    ...
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas28.js"></script>
