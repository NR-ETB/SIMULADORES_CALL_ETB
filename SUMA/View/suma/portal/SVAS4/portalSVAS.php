...
<body>
    ...
    <div class="modal fade modal-loading" tabindex="-1" id="modal-loading" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal modal-success-sim" tabindex="-1" id="modal-fase">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                <p>En el escenario de CAMBIO DE PLAN (SVAS) del simulador SUMA, hacer caso omiso a las siguientes indicaciones y aprende en el proceso</p>
                </div>
                <div class="modal-footer">
    ...
    <script src="../../../../Controller/suma/SVAS/portalSVAS4.js"></script>
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas7.js"></script>
