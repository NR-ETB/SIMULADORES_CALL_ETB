...
<body>
        ...
        <div class="main-principal-portal">
            <div class="contedor-portal">
                <div class="breadcump">
                    ...
                    <a href="#" class="item-bread">CAMBIO DE PLAN (PRCH)</a>
            </div>
            <div class="con-main-pasos">
                <div class="con-pasos sw-main sw-theme-arrows" id="smartwizard">
                    <ul class="nav nav-tabs step-anchor">
                        ...
                        <li class="nav-item" id="pasoli-2"><a class="nav-link">Paso 2<br><small>Seleccion de Plan</small></a></li>
                        <li class="nav-item" id="pasoli-3"><a class="nav-link">Paso 3<br><small>Validación Cliente</small></a></li>
                        <li class="nav-item" id="pasoli-4"><a class="nav-link">Paso 4<br><small>Validación Confronta</small></a></li>
                        <li class="nav-item" id="pasoli-5"><a class="nav-link">Paso 5<br><small>Disponibilidad</small></a></li>
                        <li class="nav-item" id="pasoli-6"><a class="nav-link">Paso 6<br><small>Agendamiento</small></a></li>
                        <li class="nav-item" id="pasoli-6"><a class="nav-link">Paso 7<br><small>Finalización</small></a></li>
                        <li class="nav-item nav-item-alert"><a class="nav-link">
                            ...
                            <source type="audio/wav" src="../../../../Model/audioSuma/audio_com/gcs23.mp3">
                            </audio>
                        </a></li>   
                    </ul>
                </div>
                ...
                <!-- Paso 1 -->
                    <div class="paso-1" id="paso-1" >
                        ...
                        <div class="con-btn-paso-2">
                            <div class="mar">
                                <button id="btn-paso-3" onclick="valid(),habladorText('En este apartado podras observar los bundles disponibles, Selecciona el bundle DUO, para esto, puedes seleccionar en la plabra 2PLAY o cambiarlo con los botones inferiores, acto seguido presiona en Siguiente.')">SIGUIENTE >></button>
                            </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="paso" id="paso-2" >
                        ...
                        <div style="display:flex; justify-content: space-around; margin-top: 15px;">
                            <div>
                                <span style="color: var(--orange-etb);">UEN</span>
                                <select name="" id="">
                            ...
                            <div>
                                <span style="color: var(--orange-etb);">Tipo de Oferta</span>
                                <select name="" id="">
                                    <option value="">Seleccione una Opción</option>
                                </select>
                            </div>
                            ...
                            <div>
                                <span style="color: var(--orange-etb);">Tecnologia</span>
                                <select name="" id="">
                                    <option value="">Seleccione una Opción</option>
                                </select>
                            </div>
                            ...
                            <div>
                                <span style="color: var(--orange-etb);">Plan</span>
                                <select name="" id="">
                                    <option value="">Seleccione una Opción</option>
                                </select>
                            </div>
                        ...
                        <div class="con-it-o2" id="ocul2" style="position: relative; right: 250px; top: 50px; z-index: 1000;">

                                <div class="items-info2" style="height: 320px; width: 980px;">
                                    <div class="body-items-inf">
                                    <div class="content" >
                                        <div style="background-color: #20A4CB; height: 260px; width: 200px; color: var(--orange-etb); font-size: 24px; text-align: center;">
                                            <br>
                                            <p onclick="play1();" style="cursor: pointer;">3 PLAY</p>
                                            <br>
                                            <p onclick="play2();" style="cursor: pointer;">2 PLAY</p>
                                            <br>
                                            <p onclick="play3();" style="cursor: pointer;">SINGLE</p>
                                        </div>
                                            <div class="bundle2" id="bundle1" style="position: relative; left: 300px; opacity: 50%; bottom: 270px;">
                                                <div class="header-b">
                                                    <p class="f-h-b">DUO 300MB HOG V7 <input id="b1" type="checkbox"></p>
                                            ...
                                            <div class="bundle2" id="bundle2" style="position: relative; bottom: 668px; left: 600px; width: 340px;">
                                                <div class="header-b">
                                                    <p class="f-h-b">DUO 500MB HOG V7</p>
                                                    <p style="bottom: 12px; position: relative;">$ 90900  <span>Mes</span></p>
                                                    <div class="header-serv">
                                                        <p><span>Mensual</span></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="bundle2" id="bundle3" style="display: none; position: relative; opacity: 50%; bottom: 668px; left: 600px; width: 340px;">
                                                <div class="header-b">
                                                    <p class="f-h-b">SINGLE 100M FTTH</p>
                                                    <p style="bottom: 12px; position: relative;">$ 30900  <span>Mes</span></p>
                                                    <div class="header-serv">
                                                        <p><span>Mensual</span></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="bundle2" id="bundle4" style="position: relative; bottom: 668px; left: 600px; width: 340px; display: none;">
                                                <div class="header-b">
                                                    <p class="f-h-b">TRIO 500M SILVER MIPYMES FTTH V1</p>
                                                    <p style="bottom: 12px; position: relative;">$ 215900  <span>Mes</span></p>
                                                    <div class="header-serv">
                                                        <p><span>Mensual</span></p>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="sa" style="position: relative; bottom: 947px; left: 530px;">
                                            <button onclick="ant();" style="border: none; background-color: transparent;"><img src="../../../images/images-suma/calendarbtn2.png" alt=""></button>
                                            <button onclick="sig();" style="border: none; background-color: transparent;"><img src="../../../images/images-suma/calendarbtn.png" alt=""></button>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="items-info2" style="height: 370px; top: 100px;">
                                    ...
                                    <div class="content" >
                                        <div style="display: flex;">
                                            <input type="checkbox"><p style="color: var(--orange-etb); margin-top: 15px;">HDT GO $ 23800</p>
                                        </div>
                                        <div style="display: flex;">                                        
                                            <input type="checkbox" checked><p style="color: var(--orange-etb); margin-top: 15px;">1 IP PUBLICA FIJA NEG $ 0</p>
                                        </div>
                                        <div style="display: flex;">
                                            <input type="checkbox"><p style="color: var(--orange-etb); margin-top: 15px;">1 IP-SERVICIO DEDICADO $ 12400</p>
                                        </div>
                                        <div style="display: flex;">
                                            <input type="checkbox"><p style="color: var(--orange-etb); margin-top: 15px;">MI NEGOCIO EN REDES SOCIALES $ 16500</p>
                                        </div>
                                        <div style="display: flex;">
                                            <input type="checkbox"><p style="color: var(--orange-etb); margin-top: 15px;">MI NEGOCIO WEB $ 43500</p>
                                        </div>
                                        <div style="display: flex;">
                                            <input type="checkbox"><p style="color: var(--orange-etb); margin-top: 15px;">MICRO SEGURO (10 DISP) $ 9900</p>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                        ...
                        <div id="btn-comp" class="btn-flot" onclick="btn_comp(), habladorText('Aqui podras apreciar, la diferencia entre el plan actual del cliente y el Seleccionado');" style="width: 280px; z-index: 1030;">
                            COMPARACIÓN DE PLANES
                        </div>
                        
                        <div>
                            <button style="width: 370px; color: #fff; border: none; border-radius: 15px; background-color: var(--orange-etb); position: relative; left: 1125px; bottom: 250px;">Configurar Bundle Auxiliar</button>
                        </div>
                        ...
                        <a style="color: var(--orange-etb); position: relative; bottom: 190px; left: 700px; z-index: 1001; cursor: pointer;" onclick="btn_or();"><u>Ver Resumen de Compra</u></a>

                        <div class="con-btn-paso-2" style="display: flex; position: relative; bottom: 190px;  z-index: 1001;"> 
                  ...
                  <div class="paso" id="paso-3" style="display: none;">
                    ...
                    <div style="display: grid; position: relative; left: 670px; top: 50px;">
                        ...
                        <div style="display: flex;">
                        <span style="color: var(--orange-etb); position: relative; right: 127px;">Fecha de Expedicion Doc. *</span><textarea id="fech" style="height: 29.5px; position: relative; right: 127px;"></textarea>
                        </div>
                        <div style="display: flex;">
                    ...
                    <div id="btn-comp" class="btn-flot" onclick="btn_comp();" style="width: 280px;">
                        COMPARACIÓN DE PLANES
                    </div>
                    
                    <a style="color: var(--orange-etb); position: relative; top: 85px; left: 700px; cursor: pointer;" onclick="btn_or();"><u>Ver Resumen de Compra</u></a>
                    ...
                    <div class="paso" id="paso-4">
                        ...
                        <div class="con-btn-paso-2" style="display: flex; position: relative; top: 60px;"> 
                            <button onclick="cancel();" style="background-color: #20A4CB;">CERRAR INTERACCIÓN</button>
                            <button onclick="btn_paso_5(),habladorText('En este apartado, podras apreciar todos los datos del cliente en una vista expandida, selecciona la casilla de Enviar Correo Notificacion, presiona Siguiente para continuar.')"">SIGUIENTE >></button>
                        </div>
                   </div>
                  ...
                  <div class="paso" id="paso-5">
                    ...
                    <div class="cards" style="height: 140px; bottom: 492px;">
                        ...
                        <section class="right" style="margin-top: 30px;">
                            ...
                            <textarea name="" id="" style="height: 29.5px; width: 170px;"></textarea><button style="background: var(--orange-etb); border: 2px solid var(--orange-etb); border-radius: 10px; position: relative; bottom: 10px;"><img style="height: 20px; width: 18px;" src="../../../images/images-suma/pencil.png" style="width: 25px; height: 25px;" alt=""></button>
                            <br>
                            <br>
                        </section>
                    </div>
                    ...
                    <div class="con-btn-paso-2" style="display: flex; position: relative; top: 50px;"> 
                        <button style="background-color: #20A4CB;" onclick="cancel();">CERRAR INTERACCIÓN</button>
                        <button onclick="btn_paso_6(),habladorText('En este apartado se realizara el agendamiento correspondiente para el tramite, en algunos casos como en este, no se debera realizar un agendamiento por lo que puedes continuar, presionando el boton Siguiente,')">SIGUIENTE >></button>
                    </div>
                </div>
                  ...
                  <div class="paso" id="paso-6">
                    ...
                    <div class="con-btn-paso-2" style="display: flex; position: relative; top: 50px;"> 
                        <button style="background-color: #20A4CB;" onclick="cancel();">CERRAR INTERACCIÓN</button>
                        <button onclick="btn_modal_8();">SIGUIENTE >></button>
                    </div>
                </div>
    ...
    <div class="modal modal-susc" tabindex="-1" id="tab-comp" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="width: 340px; position: relative; top: 17px; margin-right: 1150px;">
                <div class="modal-header" style="background-color: var(--orange-etb);">
                    <h5 style="color: #fff;">COMPARACIÓN DE PLANES</h5>
                    ...
                    <table class="table-general table-sopor table-produc">
                        <thead>
                            <tr>
                                ...
                                <th style="color: var(--orange-etb); background-color: #fff;">Plan Actual</th>
                                <th style="color: var(--orange-etb); background-color: #fff;">Plan Nuevo</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <td  colspan="2"style="background-color: var(--orange-etb); color: #fff;">LINEA TELEFONICA</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">MARCACION TELEFONICA</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">VOZ LOCAL ILIMITADA</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">IDENTIFICADOR DE SEGUNDA LLAMADA</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">CONEXION SIN MARCAR</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">LLAMADA EN ESPERA</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">CONFERENCIA ENTRE TRES</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">TRANSFERENCIA DE LLAMADA</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="background-color: var(--orange-etb); color: #fff;">INTERNET</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">PUNTO CABLEADO</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">PLAN DE 300M/300M</td>
                                <td><img src="../../../images/images-suma/xred.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">IP DINÁMICA</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">PLAN DE 500M/500M</td>
                                <td><img src="../../../images/images-suma/checkgreen.png" style="width: 25px; height: 25px;" alt=""></td>
                                <td><img src="../../../images/images-suma/xred.png" style="width: 25px; height: 25px;" alt=""></td>
                            </tr>
                        </tbody>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            <p>Has finalizado con exito el escenario CAMBIO DE PLAN (PRCH) del Simulador SUMA, recuerda que siempre esta a tu disposicion y cuentas con intentos ilimitados :)</p>
            </div>
            <div class="modal-footer">
    ...
    <script src="../../../../Controller/suma/SVAS/portalSVASPartII3.js"></script>
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas8.js"></script>
