...
<body style="overflow-y: hidden;">
                ...
                <div class="breadcump">
                    ...
                    <div class="paso" id="paso-5" style="display: none;">
                            ...
                            <div class="body-items-inf">
                                <div class="content-fact-fac" id="con-sopo-inter">
                                    ...
                                    <div class='content-item-info item-1' style="margin-top: 25px;">
                                        <label>Canal:</label> 
                                        <select name="" id="" style="width: 300px;" onchange="sms(),habladorText('Deberas introducir el codigo que se enviara directamente al celular ingresado <br><br> CODIGO: 798106')">
                        ...
                        <div class="con-btn-paso-2" style="display: flex; position: relative; top: 60px;"> 
                            ...
                            <button id="edn2" onclick="location.href='./portalSVASPartIII.php'" style="display: none;">FINALIZAR</button>
                        </div>
                   </div>
    ...
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas27.js"></script>
