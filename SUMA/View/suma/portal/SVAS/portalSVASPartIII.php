...
<body>
                           ...
                           <div class="table-product" id="con-sopo-inter">
                                <div class="con-table">
                                    <table class="table-general table-sopor table-produc">
                                        ...
                                        <tbody onclick="tabac1(),tabac2(),habladorText('Para realizar la gestion, primero deberas dirigirte al apartado Tramites Fija, en la barra lateral izquiera, acto seguido selecciona la opcion Adición SVA´S (ASER)');">
                            ...
                            <div class="body-items-inf">
                                <div class="content-soport-sop" id="con-sopo-inter">
                                        ...
                                        <div class='content-item-info'>
                                            <label>Central:</label> <span>SOACHA</span><br>
    ...
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas24.js"></script>
