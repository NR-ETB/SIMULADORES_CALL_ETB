...
<body>
            ...
            <div class="acon-main-pasos">
                <div class="con-pasos sw-main sw-theme-arrows" id="smartwizard">
                    <ul class="nav nav-tabs step-anchor">
                        ...
                        <li class="nav-item" id="pasoli-2"><a class="nav-link">Paso 2<br><small>Cambios SVAs</small></a></li>
                        <li class="nav-item" id="pasoli-3"><a class="nav-link">Paso 3<br><small>Valoración Cliente</small></a></li>
                        <li class="nav-item" id="pasoli-4"><a class="nav-link">Paso 4<br><small>Valoración Contratista</small></a></li>
                        <li class="nav-item" id="pasoli-5"><a class="nav-link">Paso 5<br><small>Disponibilidad</small></a></li>
                        <li class="nav-item" id="pasoli-6"><a class="nav-link">Paso 6<br><small>Datos Adicionales</small></a></li>
                        <li class="nav-item" id="pasoli-7"><a class="nav-link">Paso 7<br><small>Agendamiento</small></a></li>
                        <li class="nav-item" id="pasoli-8"><a class="nav-link">Paso 8<br><small>Finalización</small></a></li>
                ...
                <div class="paso-1" id="paso-1" >
                        ...
                        <div class="con-btn-paso-2">
                            <div class="mar">
                                <button id="btn-paso-3" onclick="valid(),habladorText('En este apartado podras observar tanto el bundle seleccionado, las promociones actuales del cliente y tambien podras ver los Svas disponibles, Selecciona el Svas HBO PACK $ 24900')">SIGUIENTE >></button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="btn-comp" class="btn-flot" onclick="btn_comp(), habladorText('Aqui podras apreciar, una sencilla comparación de los SVAs que al cliente se le han adicionado o retirado');" style="width: 280px; background-color: #20A4CB;">
                        ...
                        <a onclick="btn_or();" style="color: var(--orange-etb); position: relative; bottom: 230px; left: 700px;"><u>Ver Resumen de Compra</u></a> 
                        ...
                        <div class="con-btn-paso-2" style="display: flex; position: relative; bottom: 230px;"> 
                          ...
                          <button onclick="btn_paso_3(),habladorText('En este apartado podras observar los datos del cliente, en algunos casos, el sistema omitira este paso y redirigira al usuario hasta el paso 6, de igual manera puedes ingresar la fecha de expedicion del cliente **12/08/2024** para continuar presiona en Siguiente.')">SIGUIENTE >></button>
                      </div>
                   </div>
                    <!-- Paso 2 -->

                    <!-- Paso 3 -->
                    <div class="paso-3" id="paso-3" style="display: none;">
                        ...
                        <div style="display: grid; position: relative; left: 670px; top: 50px;">
                            ...
                            <div style="display: flex;">
                            <span style="color: var(--orange-etb); position: relative; right: 127px;">Fecha de Expedicion Doc. *</span><textarea name="" id="" style="height: 29.5px; position: relative; right: 127px;"></textarea>
                            </div>
                            <div style="display: flex;">
                        ...
                        <a onclick="btn_or();" style="color: var(--orange-etb); position: relative; top: 70px; left: 700px;"><u>Ver Resumen de Compra</u></a> 
                        ...
                        <div class="con-btn-paso-2" style="display: flex; position: relative; top: 60px;"> 
                          ...
                          <button onclick="btn_paso_4(),habladorText('Como existen casos en los cuales, el sistema te llevara inmediatamente al paso 6, esto sera lo unico que podras ver en la interfaz, para continuar presiona Siguiente.')">SIGUIENTE >></button>
                      </div>
                    </div>
                    <!-- Paso 3 -->
                    ...
                    <div class="paso" id="paso-4">
                        ...
                        <div class="con-btn-paso-2" style="display: flex; position: relative; top: 60px;"> 
                            <button onclick="cancel();" style="background-color: #20A4CB;">CERRAR INTERACCIÓN</button>
                            <button onclick="btn_paso_5(),habladorText('Para continuar presiona Siguiente.')">SIGUIENTE >></button>
                        </div>
                   </div>
                    ...
                    <div class="paso" id="paso-5">
                        ...
                        <div class="con-btn-paso-2" style="display: flex; position: relative; top: 60px;"> 
                            <button onclick="cancel();" style="background-color: #20A4CB;">CERRAR INTERACCIÓN</button>
                            <button onclick="btn_paso_6(),habladorText('En este apartado, podras apreciar todos los datos del cliente en una vista expandida, selecciona la casilla de Enviar Correo Notificacion, ademas de esto agrega una observacion en la casilla correspondiente y presiona Siguiente para continuar.')">SIGUIENTE >></button>
                        </div>
                   </div>
                ...
                <div class="paso" id="paso-6">
                    ...
                    <div class="con-btn-paso-2" style="display: flex; position: relative; top: 50px;"> 
                        <button style="background-color: #20A4CB;" onclick="cancel();">CERRAR INTERACCIÓN</button>
                        <button onclick="btn_paso_7(),habladorText('En este apartado se realizara el agendamiento correspondiente para el tramite, en algunos casos como en este, no se debera realizar un agendamiento por lo que puedes continuar, presionando el boton Siguiente,')">SIGUIENTE >></button>
                    </div>
                </div>
    ...
    <div class="modal" tabindex="-1" id="modal-fase1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            <p>Has finalizado con exito el escenario ADICIÓN (SVAS) del Simulador SUMA, recuerda que siempre esta a tu disposicion y cuentas con intentos ilimitados :)</p>
            </div>
            <div class="modal-footer">
    ...
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas2.js"></script>
