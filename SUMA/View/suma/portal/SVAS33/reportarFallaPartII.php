...
<body id="black">
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-exito-s">
                <div class="modal-content" style="position: relative; bottom: 50px; right: 50px; height: 480px; width: 850px;">
                    <div class="modal-header" style="background-color: #00A7CC;">
                        <h5 class="modal-title"><span id="tittle-main-exit-s">ADICION ACCESS POINT</span><span id="titulo-alerta-corr-s"></span></h5>
                    </div>
                    <div class="modal-body">
    ...
    <script src="../../../../Controller/suma/SVAS/reporteSVAS.js"></script>
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas13.js"></script>
</body>
</html>