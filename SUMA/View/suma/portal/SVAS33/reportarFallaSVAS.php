...
<body>
    ...
    <div class="container-genre">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header" id="header-cons">
                    <h5>CREANDO PQR: MDM-PQR-3939241</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="info-u info-repor">
                        ...
                        <select name="optagenda" id="ages3">
                            ...
                            <option value="2" style="background-color: rgb(192, 192, 192);">PAQUETE</option>
                        ...
                        <select name="optagenda" id="ages4">
                            <option value="0">Selecione...</option>
                            <option value="2" style="background-color: rgb(192, 192, 192);">SIN VOZ / SIN DATOS</option>
                            <option value="0">SIN VOZ / SIN DATOS / SIN TV</option>
                        </select><span style="color: red; position: relative; left: 275px; bottom: 40px;">*</span>
            
                        <label for="" class="label">Sintoma</label>
                        <select name="optagenda" id="ages5">
                            <option value="0">Selecione...</option>
                            <option value="2" style="background-color: rgb(192, 192, 192);">FALLA GENERAL DEL SERVICIO -F</option>
                        </select><span style="color: red; position: relative; left: 275px; bottom: 40px;">*</span>
            
                        <label for="" class="label">CUN</label>
                        <select name="optagenda" class="label2" id="label2">
                            <option id="cun-no-rel" value="0"></option>
                            <option id="cun-rel" value="1" style="display: none; background-color: #c0c0c0;">4347240001063780</option>
                        </select>
                                                    ...
                                                    <div class="contet hide-body con-tree-colms" id="con-sopo-infro">
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="row-bl">
                                                                        <td>Serial</td>
                                                                        <td>ZTEGD0348FB8</td>
                                                                        <td class="dell-sem">#NOTFOUND <div class="semaforo semaforo-error"></div></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Mac</td>
                                                                        <td>7426FFESE7EE</td>
                                                        ...
                                                        <div class="con-table">
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tr class="row-bl">
                                                                    <td>Estado Modem</td>
                                                                    <td class="dell-sem">Power-Off<div class="semaforo semaforo-error"></div></td>
                                                                </tr>

                                                                <tr>
                                                                    <td>Potencia</td>
                                                                    <td class="dell-sem">--<div class="semaforo semaforo-error"></div></td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
        ...
        <div class="modal fade modales-soporte" tabindex="-1" id="modal-reapro-serv-temp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #d95000;">
                                <h5 class="modal-title"><span id="tittle-main-exit">Fuera de Línea</span><span id="titulo-alerta-corr"></span></h5>
                            </div>
                            <div class="modal-body">
                                <h3>La ont esta fuera de linea validar conexiones con el cliente</h3>
                                <br>
                                <p id="contenido-alerta-cor"></p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" data-bs-dismiss="modal" id="btn-modal-ps4error" style="background: #00A7CC; color: #fff; border: #00A7CC;">Aceptar</button>
                            </div>
                        </div>
                    </div>
        </div>
    ...
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas14.js"></script>
