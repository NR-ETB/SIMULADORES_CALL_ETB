...
<body>
    ...
    <div class="container-genre">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header" id="header-cons">
                    <h5>CREANDO PQR: MDM-PQR-3939242</h5>
                ...
                <div class="modal-body">
                    ...
                    <ul>
                            ...
                            <select name="optagenda" id="ages2">
                                ...
                                <option value="0">INFORMACION Y/O DOCUMENTACION</option>
                                <option value="0">PREVENTIVO BACK</option>
                                <option value="0">RECLAMO INTERNO</option>
                                <option value="0">TRAMITES CON AGENDAMIENTO</option>
                                <option value="0">TRAMITES SIN AGENDAMIENTO</option>
                            </select><span style="color: red; position: relative; left: 275px; bottom: 40px;">*</span>
                
                            <label for="" class="label">Producto</label>
                            <select name="optagenda" id="ages3">
                                <option value="0">Selecione...</option>
                                <option value="0">TELEFONIA MOVIL (LTE)</option>
                                <option value="0">DATOS MOVILES</option>
                                <option value="2" style="background-color: rgb(192, 192, 192);">INTERNET</option>
                                <option value="0">TELEVISION</option>
                                <option value="0">PAQUETE</option>
                                <option value="0">LINEA BASICA</option>
                            </select><span style="color: red; position: relative; left: 275px; bottom: 40px;">*</span>
                
                            <label for="" class="label">Causal</label>
                            <select name="optagenda" id="ages4">
                                <option value="0">Selecione...</option>
                                <option value="2" style="background-color: rgb(192, 192, 192);">BAJA CALIDAD DEL SERVICIO</option>
                                <option value="0">FALLA EN CPE</option>
                                <option value="0">FALLA INTERNET</option>
                                <option value="0">FALLA WIFI</option>
                                <option value="0">GESTION PROACTIVA</option>
                            ...
                            <select name="optagenda" id="ages5">
                                <option value="0">Selecione...</option>
                                <option value="0">PROBLEMA EQUIPO DEL CLIENTE</option>
                        ...
                        <select name="optagenda" class="label2" id="label2">
                            ...
                            <option id="cun-rel" value="1" style="display: none; background-color: #c0c0c0;">4347240001063781</option>
                        </select>
                            ...
                            <!-- Contenido del modal -->
                                <div class="modal-body">
                                    ...
                                    <div class="info-u">
                                        <label for="">Cliente</label>
                                        <label for="">Número de Documento</label>
                                        <p id="nomCli">NATALIA FERNANDES</p>
                                        <p id="docCli">1000958632</p> 
                                    </div>
                                    ...
                                    <div class="table-solui">
                                        ...
                                        <button type="button" class="btn_clasic btn_orage_bg" id="btn-solucion" onclick="btn_solucion_22();">Aceptar</button>
                                    </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="contet hide-body con-tree-colms" id="con-sopo-infro">
                                                        ...
                                                        <div class="items-actions-soporte six__actions">
                                                            ...
                                                            <div class="dropdrown-act" id="dropdrown-act-infr">
                                                                ...
                                                                <label for="" onclick="habladorText('Esto ejecutará un proceso interno, el cual reiniciará la configuración de fabrica.')">Reinicio de Fábrica</label>
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    <tr class="row-bl">
                                                                        <td>Serial</td>
                                                                        <td>ZTE</td>
                                                                        <td class="info__sem">ZTEGD0348FBB <div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                    ...
                                                    <div class="contet hide-body con-tree-colms" id="con-sopo-telefo">
                                                        ...
                                                        <div class="items-actions-soporte items__actions_four">
                                                            ...
                                                            <div class="dropdrown-act drowndown__fon" id="dropdrown-act-linea-t">
                                                                <label for="" onclick="habladorText('Esto ejecutará un proceso interno, Normalizará todos los servicios, por consiguiente todos los semaforos serán refrescados.')" id="btn-norm-se-secun">Normalizar Servicios Suplementarios</label>
                                                                ...
                                                                <label for="" onclick="habladorText('Normalizará el número telefonico que se encuentra configurado según el Modem')" id="btn-norm-tel-modem">Normalizar No. Tel Configurado en Modem</label>
        ...
        <div class="modal fade modales-soporte" tabindex="-1" id="modal-reapro-serv-temp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #d99e00;">
                                <h5 class="modal-title"><span id="tittle-main-exit">Fuera de Línea</span><span id="titulo-alerta-corr"></span></h5>
                            </div>
                            <div class="modal-body">
                                <h3>Existe una falla física, que requiere visita técnica</h3>
                                <br>
                                <p id="contenido-alerta-cor"></p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" data-bs-dismiss="modal" onclick="btn_of();" style="background: #00A7CC; color: #fff; border: #00A7CC; border-radius: 15px;">Aceptar</button>
                            </div>
                        </div>
                    </div>
        </div>
        ...
        <div class="modal modal-success-sim" tabindex="-1" id="modal-fase1">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <p>Has finalizado con exito el escenario SOPORTE PRIMER NIVEL (SVAS) del Simulador SUMA, recuerda que siempre esta a tu disposicion y cuentas con intentos ilimitados :)</p>
                    </div>
                    <div class="modal-footer">
    ...
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas18.js"></script>
    <script src="../../../../Controller/suma/SVAS/soporteSVAS.js"></script>
