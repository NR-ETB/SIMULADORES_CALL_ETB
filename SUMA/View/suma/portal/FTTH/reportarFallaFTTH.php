...
<body>
    ...
    <div class="container-genre">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header" id="header-cons">
                    <h5>CREANDO PQR: MDM-PQR-3939226</h5>
                                                ...
                                                <div class="body-items-inf item-larg">
                                                    <div class="contet hide-body con-tree-colms" id="con-sopo-infro">
                                                        ...
                                                        <div class="items-actions-soporte six__actions">
                                                            ...
                                                            <button style="background: #00C2DF; font-size: 15px;" id="btn-consul-equipos" onclick="habladorText('Muestra algunas imágenes sobre la ONT instalada')">Imagen de Equipos</button>
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    <tr class="row-bl">
                                                                        ...
                                                                        <td>300M</td>
                                                                        <td class="info__sem" id="internet5">300M <div class="semaforo semaforo-temp"></div></td>
                                                                        <td class="info__sem" id="internet6" style="display: none;">300M <div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Velocidad Subida</td>
                                                                        <td>300M</td>
                                                                        <td class="info__sem" id="internet7">300M <div class="semaforo semaforo-temp"></div></td>
                                                                        <td class="info__sem" id="internet8" style="display: none;">300M <div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                    ...
                                                    <div class="contet hide-body con-tree-colms" id="con-sopo-inter">
                                                        ...
                                                        <div class="items-actions-soporte items__actions_four">
                                                            ...
                                                            <div class="dropdrown-act drowndown__fon" id="dropdrown-act-internet">
                                                                ...
                                                                <label for="" onclick="inter1(), habladorText('Permite sincronizar las velocidades de acuerdo a la ordén')">Normalizar Velocidades</label>
                                                                ...
                                                                <label for="" onclick="inter2(), habladorText('Sobrescribe los valores guardados en ACS en la ONT/CPE')">Reaprovisionar Servicio - ACS</label>
                                                ...
                                                <div class="body-items-inf">
                                                    <div class="contet hide-body con-tree-colms" id="con-sopo-tv">
                                                        ...
                                                        <div class="items-actions-soporte seven__actions">
                                                            <button style="background: #00C2DF; font-size: 15px;" id="btn-consul-equipos2" onclick="habladorText('Muestra algunas imágenes sobre la ONT instalada')">Imagen de Equipos</button>
        ...
        <div class="alert-flotante" id="alert-flotante22">
        ...
        <div id="flujo-btn" class="btn-flot" onclick="btn_flujo()">
            Flujo
        </div>
    ...
    <script src="../../../../Controller/security/FTTH/anti-cheat-ftth7.js"></script>
