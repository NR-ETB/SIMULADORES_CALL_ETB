...
<body>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header" id="header-cons">
                    <h5>CREANDO PQR: MDM-PQR-3939227</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="info-u info-repor">
                        ...
                        <select name="optagenda" id="ages3">
                            ...
                            <option value="4" style="background-color: rgb(192, 192, 192);">TELEVISION</option>
                        ...
                        <select name="optagenda" id="ages4">
                            ...
                            <option value="2" style="background-color: rgb(192, 192, 192);">FALLA TOTAL SERVICIO IPTV</option>
                            <option value="3">FALLA PARCIAL DEL SERVICIO</option>
                            <option value="4">FALLA EN CPE</option>
                            <option value="5">FALLA EN SVA</option>
                            <option value="6">SIN TV</option>
                        </select><span style="color: red; position: relative; left: 275px; bottom: 40px;">*</span>
                        ...
                        <select name="optagenda" id="ages5">
                            ...
                            <option value="2" style="background-color: rgb(192, 192, 192);">AUSENCIA DE SEÑAL TOTAL -F</option>
                        </select><span style="color: red; position: relative; left: 275px; bottom: 40px;">*</span>
            
                        <label for="" class="label">CUN</label>
                        <select name="optagenda" class="label2" id="label2">
                            <option id="cun-no-rel" value="0"></option>
                            <option id="cun-rel" value="1" style="display: none; background-color: #c0c0c0;">4347240001063767</option>
                        </select>
                                                    ...
                                                    <div class="contet hide-body con-tree-colms" id="con-sopo-tv">
                                                        ...
                                                        <div class="items-actions-soporte seven__actions">
                                                            ...
                                                            <div class="dropdrown-act drowndown__fon" id="dropdrown-act-tv">
                                                                ...
                                                                <label for="" onclick="inter5(), habladorText('Esta función no esta disponible para esta orden')">Normalizar Plan TV</label>
    ...
    <script src="../../../../Controller/security/FTTH2/anti-cheat-ftth7.js"></script>
