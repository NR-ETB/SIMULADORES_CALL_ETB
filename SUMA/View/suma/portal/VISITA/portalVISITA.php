...
<body>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="dates(),habladorText('Cliente: MILLO MATEOS <br> Numero de Documento: PS 1000110440 <br> Numero de Conexion: 6012078614 <br> Cuenta Facturacion: 3333');">ACEPTAR</button>
                </div>
            </div>
            </div>
    </div>
