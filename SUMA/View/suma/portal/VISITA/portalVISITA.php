...
<body>
                           ...
                           <div class="table-product" id="con-sopo-inter">
                                <div class="con-table">
                                    <table class="table-general table-sopor table-produc">
                                        ...
                                        <tbody onclick="tabac(),tabac2(),habladorText('Para realizar la gestion, primero deberas dirigirte al apartado PQR, en la barra lateral izquiera, acto seguido selecciona la opcion Consultar PQR');">
    ...
    <div class="modal fade modal-loading" tabindex="-1" id="modal-loading" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal modal-success-sim" tabindex="-1" id="modal-fase">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                <p>En el escenario de VISITA ABIERTA del simulador SUMA, hacer caso omiso a las siguientes indicaciones y aprende en el proceso</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="btn-modal-ps4error" onclick="habladorText('Numero de Conexion: 6012078614 <br> Cuenta Facturacion: 3333');">ACEPTAR</button>
                </div>
            </div>
            </div>
        </div>
    ...
    <script src="../../../../Controller/security/VISITA/anti-cheat-visita2.js"></script>

    <script>
        habladorText('Cliente: MILLO MATEOS <br> Tipo de Documento: PS <br> Numero de Documento: 1000110440')
    </script>
