...
<div class="main-pqr"> 
            ...
            <table class="table-general table-sopor" style="width: 400px; position: relative; bottom: 10px; margin: 20px 0 0 60px;">
                ...
                <tr class="row-bl" id="bus">
                    ...
                    <td>PETICION</td>
                    <td>FALLA TECNICA</td>
                    <td>4347230002457862</td>
                    <td></td>
                    <td>6015486357</td>
                    <td><img src="../../../images/images-suma/folder.png" style="position: relative; left: 60px; width: 20px; height: 20px;" onclick="location.href='pqrVISITA.php'"></td>
                    <td></td>
                </tr>
                <tr id="bus1">
                    ...
                    <td>3921039470</td>
                    <td>6016273535</td>
                    <td><img src="../../../images/images-suma/folder.png" style="position: relative; left: 60px; width: 20px; height: 20px;"></td>
                    <td></td>
                </tr>
                <tr class="row-bl" id="bus2">
                    <td><div class="semaforo semaforo-error"></div></td>
                    <td>11</td>
                ...
                <tr class="row-bl" id="bus4">
                    <td><div class="semaforo semaforo-co"></div></td>
                    <td>0</td>
                    <td>MDM-PQR-38625977</td>
                    <td>nnicrod</td>
                    <td>VERONICA CASTAÑO</td>
                    <td>18/04/2024 11:51:10 p.m.</td>
                    <td>CREACION</td>
                    <td></td>
                    <td></td>
                    <td></td>
    ...
    <script src="../../../../Controller/security/VISITA/anti-cheat-visita.js"></script>
