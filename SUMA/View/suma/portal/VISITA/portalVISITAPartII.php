...
<body>
        ...
        <div class="main-principal-portal">
            <div class="contedor-portal">
                <div class="breadcump">
                    ...
                    <div id="age" class="menus" style="display: block;">
                    ...
                    <div class="items-info items-sopor item-datas">
                        ...
                        <div class="body-items-inf" style="height: 330px;">
                            <div class="content-info" id="con-sopo-inter">
                                                ...
                                                <label>Nombre:</label> <span>MILLO MATEOS</span><br>
                                                <label>Tipo de Documento:</label> <span>PASAPORTE</span><br>
                                                <label>Numero de Documento:</label> <span>1000110440</span><br>
                                                <label>Email:</label> <span>mil@email.com</span><br>
                                                <label>Telefono Fijo:</label> <span>6012078614</span><br>
                                                ...
                                                <label>Celular:</label> <span>3135496018</span><br>
                                                <label>Departamento:</label> <span>VALLE DEL CAUCA</span><br>
                                                <label>Ciudad:</label> <span>CALI</span><br>
                                                <label>Direccion:</label> <span>Calle 12D #21 b 29</span><br>
                                                ...
                                                <div style="position: relative; left: 230px; bottom: 3px;">
                                                    ...
                                                    <label>Categoria:</label> <span>ORO</span><br>
                            ...
                            <div class="body-items-inf">
                                <div class="content-soport-sop" id="con-sopo-inter">
                                        ...
                                        <div class='content-item-info'>
                                            ...
                                            <div class='content-item-info'>
                                            <label>Visita Abierta:</label> <i id="fal3" class='fa-solid fa-eye eye-color' onclick="btn_visit();"></i> <br>
                                            <div id="fal1"><label>PQRs Falla Técnica:</label><br></div>
                                            <div id="fal2" style="display: none;"><label>PQRs Falla Técnica:</label> <span >1</span> <i class='fa-solid fa-eye eye-color' onclick="btn_falla();"></i> <br></div>
                        ...
                        <div class="items-info items-sopor content-fact" id="df">
                            ...
                            <div class="body-items-inf">
                                <div class="content-fact-fac" id="con-sopo-inter">
                                            ...
                                            <label>Cuenta Facturacion:</label> <span>3333</span><br>
                                            <label>Estado Cta Facturacion:</label> <span>Activo</span><br>
                                            <label>Ciclo:</label> <span>64</span><br>
                                            <label>Dirección Facturación:</label> <span>Calle 12D #21 b 29</span><br>
                                            ...
                                            <label>Email Facturación:</label> <span>mil@email.com</span><br>
                                            ...
                                            <label>Departamento:</label> <span>Valle del Cauca</span><br>
                                            <label>Ciudad:</label> <span>Cali</span><br>
                                            <label>Barrio:</label> <span>001118</span><br>
                                            <label>Estrato:</label> <span>5</span><br>
                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <div class="table-product" id="con-sopo-inter">
                                ...
                                <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" onclick="btn_solucion4()">Aceptar</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-err">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>INS001-El usuario y/o password no son validos, por favor verifique</p>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal fade" id="modal-visita2"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="position: fixed; top: 50px;">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
                <div class="modal-header">
                <script>
                ...
                <div class="modal-body">
                    <div class="descrip-pqr">
                        <label for="">Id PQR:</label>
                        <br>
                        <span style=" color: #1285B6; font-weight: bold;"> Ya existe una PQR con clase: PETICION, motivo: FALLA TECNICA, con el número: MDM-PQR-3939235 creada el: <script>document.write(`${month}/${day}/${year}`)</script> <span><script>document.write(`${hours}:${minutes}`)</script>
                            en estado: Enviado a Segundo Nivel, con Agenda para la fecha:  <script>document.write(`${month}/${day}/${year}`)</script> </span>
                    </div>
                    <div class="content-modal">
                        <form>
                            <label for="">Clase<span style="margin-left: 380px; color: #ff5c5c;">*</span></label>
                            <span>
                                <select name="clase" id="">
                                    <option value="0"></option>
                                    <option value="1">ASEGURAMIENTO DE CANALES</option>
                                    <option value="2" selected>PETICIÓN</option>
                                    <option value="3">QUEJAS</option>
                                    <option value="4">RECUERSOS</option>
                                    <option value="5">RESOLUCIÓN</option>
                                    <option value="6">SOLICITUDES IAS</option>
                            ...
                            <label for="">Motivo<span style="margin-left: 372px; color: #ff5c5c;">*</span></label>
                            <span>
                                <select name="motivo" id="">
                                    <option value="0"></option>
                                    <option value="1" selected>FALLA TECNICA</option>
                                </select>
                            </span>

                            <label for="">Relación PQR</label>
                            <span><input type="text" name="relacion" id="inputValor" value="INTERNET" disabled></span>
                            <span class="select-relacion">
                                <select name="producto" id="prod" onchange="pro();">
                                    <option value="0"></option>
                            ...
                            <label for="">Causal<span style="margin-left: 368px; color: #ff5c5c;">*</span></label>
                            <span>
                                <select name="causal" id="">
                                    <option value="0"></option>
                                    <option value="1" selected>VISITA TECNICA</option>
                                    <option value="2">BAJA CALIDAD DEL SERVICIO</option>
                                    <option value="3">FALLA CPE</option>
                                    <option value="4">FALLA INTERNET</option>
                                    <option value="5">FALLA WIFI</option>
                                    <option value="6">GESTIÓN PROACTIVA</option>
                                    <option value="7">SIN DATOS</option>
                                </select>
                            </span>

                            <label for="">Sintoma<span style="margin-left: 358px; color: #ff5c5c;">*</span></label>
                            <span>
                                <select name="sintoma" id="">
                                    <option value="0">Seleccione</option>
                                    <option value="1">CONFIRMACION FECHA VISITA DAÑO</option>
                                    <option value="2">REAGENDAMIENTO FECHA VISITA DAÑO</option>
                                    <option value="3">INCUMPLIMIENTO VISITA DAÑO</option>
                                    <option value="4">INSATISFACCION VISITA DAÑO</option>
                                    <option value="5">CANCELACION VISITA DAÑO</option>
                                </select>
                            </span>

                            <label for="">Descripcion<span style="margin-left: 330px; color: #ff5c5c;">*</span></label>
                            <textarea name="descripcion" id="" cols="30" rows="3"></textarea>
                            ...
                            <select name="solicitante" id="search-soli" readonly="readonly" class="solicitante-search">
                                <option id="sol-no-rel" value="1"></option>
                                <option id="sol-rel" value="1" style="display: none;"></option>
                            </select>
                            <button type="button" id="search" onclick="btn_search();"><i class="fa-solid fa-magnifying-glass"></i></button>

                            <div id="tsearch" class="table-search" style="display: none;">
                                <div class="content-table-search">
                                    <div class="barra-busqueda">
                                        <label for="buscar">Buscar:</label>
                                        <input type="text" id="buscar" name="buscar">
                                    ...
                                    <script>
                                        ...
                                        document.addEventListener("DOMContentLoaded", function() {
                                            ...
                                            let datosFormulario = [{
                                                ...
                                                numeroDocumento: "1000110440",
                                                nombres: "MILLO",
                                                apellidos: "MATEOS",
                                                telefonoFijo: "2045786",
                                                celular: "6013154297810",
                                                email: "mil@email.com",
                                                direccion: "Calle 12D #21 b 29",
                                        ...
                                        <div class="con-table">
                                            <table class="table-general table-sopor" id="table-datos">
                                                    <tr>
                                                    <th>Solicitante</th>
                                                    <th>Numero Documento</th>
                                                    <th>Tipo Documento</th>
                            ...
                            <input value="Crear" class="crear-pqr" onclick="btn_solucion3();">
                            <img src="../../../images/speaker2.png" alt="parlante-audio-etb" class="img-audio" id="img_solicitante_fn" onclick="alertAudio('au_solicitante_fn', 'img_solicitante_fn', 2, 8)">       
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <p>Has finalizado con exito la VISITA ABIERTA del simulador SUMA, recuerda que siempre esta a tu disposicion y cuentas con intentos ilimitados :)</p>
                    </div>
                    <div class="modal-footer">
                        ...
                        <div class="items-info items-sopor item-datas" id="table1" style="height: 350px; bottom: 160px; margin: 80px 0 0 0;">
                            ...
                            <div class="body-items-inf">
                                <div class="content-info" id="con-sopo-inter">
                                    ...
                                    <div class='content-item-info item-1'>
                                    <br> 
                                    <label>Cuenta de Facturación</label> <span>3333</span><br>
                                    <br><br>
                                    <label>Ciudad Instalación</label> <span>Cali</span><br>
                                    ...
                                    <div class='content-item-info item-2'>
                                    <label>Direccion Instalación</label> <span>Calle 12D #21 b 29</span><br><br>
                                    <label>Localidad Instalación</label> <span>11</span><br>
    ...
    <script src="../../../../Controller/suma/VISITA/portalVISITA.js"></script>
    <script src="../../../../Controller/security/VISITA/anti-cheat-visita3.js"></script>
