...
<div class="main-pqr"> 
            ...
            <div class="usuario" style="margin-left: 35px;">
                <div>
                    ...
                    <span>CLAID MUSS</span>
                </div>
                <div>
                    <label for="">Cedula de Ciudadania</label>
                    <span>1000842659</span>
                </div>
                <div>
                    <label for="">Id PQR</label>
                    <span style="color: #000;">MDM-PQR-3939235</span>
                </div>
            </div>
            ...
            <div class="usuario" style="margin-bottom: 100px; margin-left: 35px;">
                <div>
                    ...
                    <span style="color: #000;">6013215796485</span>
                </div>
                <div>
                    <label for="">Cuenta de Facturacion:</label>
                    <span style="color: #000;">444444444444</span>
                </div>
                <div>
                    <label for="">ID Servicio:</label>
                    <span style="color: #000;">CS-915437</span>
                </div>
            </div>
                    ...
                    <script>
                        ...
                        <form>
                            ...
                            <select name="solicitante" id="search-soli" readonly="readonly" class="solicitante-search" style="background-color: #c0c0c0; width: 735px; margin-bottom: 20px;">
                                ...
                                <option id="cun-rel2" value="1" style="display: none;">CLAID MUSS</option>
                            </select>
                            ...
                            <textarea name="descripcion" id="" cols="30" rows="3" style="margin-bottom: 20px; border-color: #f26821;" disabled>Interrupción total del servicio de internet presentada en servicios fibra
                            </textarea>
                        ...
                        <form style="position: relative; left: 800px; bottom: 1275px;">
                            ...
                            <span>
                                <select name="clase" id="" style="margin-bottom: 20px;">
                                    <option value="1">INTERMITENCIA -F</option>
                                </select>
                            </span>

                            <label for="">Accion a Seguir</label>
                            <textarea name="descripcion" id="" cols="30" rows="3" style="margin-bottom: 20px; border-color: #f26821;">Navegación Flujos Guiados
                            </textarea>
                            ...
                            <select name="solicitante" id="search-soli" readonly="readonly" class="solicitante-search" style="background-color: #c0c0c0; width: 735px; margin-bottom: 20px;">
                                <option id="cun-rel" value="1">615423978541203</option>
                            </select>
    ...
    <script src="../../../../Controller/suma/FTTH/cpqrFTTH.js"></script>
    <script src="../../../../Controller/security/FTTH3/anti-cheat-ftth3.js"></script>
