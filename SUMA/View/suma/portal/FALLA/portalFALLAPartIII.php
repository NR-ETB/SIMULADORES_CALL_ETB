...
<body>
                    ...
                    <div class="items-info items-sopor item-datas">
                        ...
                        <div class="body-items-inf" style="height: 290px;">
                            <div class="content-info" id="con-sopo-inter">
                                                ...
                                                <label>Nombre:</label> <span>VIVIAN ALVARADO</span><br>
                                                <label>Tipo de Documento:</label> <span>CE</span><br>
                                                <label>Numero de Documento:</label> <span>1000748526</span><br>
                                                <label>Email:</label> <span>vivi@email.com</span><br>
                                                <label>Telefono Fijo:</label> <span>6012045786</span><br>
                                                <label>Usuario MiETB:</label> <span>vivi@email.com</span><br>
                                                <label>Tipo de Atencion:</label> <span>D</span><br>
                                                ...
                                                <label>Celular:</label> <span>3195421013</span><br>
                                                <label>Departamento:</label> <span>ANTIOQUIA</span><br>
                                                <label>Ciudad:</label> <span>MEDELLIN</span><br>
                                                <label>Direccion:</label> <span>Calle 4D #45 a 28</span><br>
                            ...
                            <div class="body-items-inf">
                                <div class="content-soport-sop" id="con-sopo-inter">
                                        ...
                                        <div class='content-item-info'>
                                            <label>Central:</label> <span>CENTRAL CUNI</span><br>
                                            <label>Equipo:</label> <span>BOCUZTC60104003</span><br>
                                            <label>Molécula:</label> <span>N4CU07_E15</span><br>
                                            <label>Falla Masiva:</label> <br>
                                            </div>

                                            <div class='content-item-info'>
                                            <label>Visita Abierta:</label><br>
                                            <label>PQRs Falla Técnica:</label> <span>0</span> <i class='fa-solid fa-eye eye-color' onclick="btn_falla();"></i><br>
                        ...
                        <div class="items-info items-sopor content-fact" id="df" style="display: none;">
                            ...
                            <div class="body-items-inf">
                                ...
                                <div class='content-item-info item-1'>
                                            <label>Cuenta Facturacion:</label> <span>22222222222</span><br>
                                            <label>Estado Cta Facturacion:</label> <span>Activo</span><br>
                                            <label>Ciclo:</label> <span>64</span><br>
                                            <label>Dirección Facturación:</label> <span>Calle 4D #45 a 28</span><br>
                                            ...
                                            <label>Email Facturación:</label> <span>vivi@email.com</span><br>
                                            ...
                                            <label>Departamento:</label> <span>Antioquia</span><br>
                                            <label>Ciudad:</label> <span>Medellin</span><br>
                                            <label>Barrio:</label> <span>002204</span><br>
                ...
                <div class="table-product" id="con-sopo-inter">
                                <div class="con-table2">
                                    <table class="table-general table-sopor table-produc">
                                        ...
                                        <td>Detalle</td>
                                        <td><i class='fa-solid fa-eye eye-color' onclick="location.href='./pqrFALLAPartII.php'"></i></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                ...
                                <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" onclick="btn_of2()">Aceptar</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            <p>Has finalizado con exito el escenario de FALLA MASIVA del Simulador SUMA, recuerda que siempre esta a tu disposicion y cuentas con intentos ilimitados :)</p>
            </div>
            <div class="modal-footer">
    ...
    <script src="../../../../Controller/suma/FALLA/portalFALLA2.js"></script>
    <script src="../../../../Controller/security/FALLA/anti-cheat-falla6.js"></script>
