...
<div class="usuario" style="margin-left: 35px;">
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>PQR MDM-PQR-3939230 cerrada correctamente</p>
                    </div>
                    <div class="modal-footer">
    ...
    <script src="../../../../Controller/suma/FALLA/pqr2FALLA.js"></script>
    <script src="../../../../Controller/security/FALLA/anti-cheat-falla2.js"></script>
