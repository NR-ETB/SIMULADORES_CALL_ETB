...
<div class="container-genre">
        ...
        <div class="main-pqr">
            ...
            <div>
                ...
                <audio id="au_pqr" class="audio" style="display: none;">
                    <source type="audio/wav" src="../../../../Model/audioSuma/audio_com/gcs7.mp3">
                </audio>
            </div>
            </div>
            ...
            <div class="usuario">
                <div>
                    ...
                    <span>INFORMATIVO Y/O DOCUMENTO</span>
                </div>
                <div>
            ...
            <div class="usuario" >
                <div style="position: relative; bottom: 40px;">
                    ...
                    <textarea name="descripcion" id="" cols="30" rows="3" disabled>Apreciado cliente, en este momento presentamos una falla en el sector por lo que se pueden presentar ausencia o degradacion en sus servicios; nuestro personal tecnico se encuentra en la labor de solucionar estos inconvenientes y se estima que todo se estabilizara el 8/9/2024 a las 15:23. De antemano le pedimos excusas por las molestias y te comunicaremos del avance de la solucion de la falla presentada.</textarea>
                </div>
            </div>
            ...
            <table class="table-general table-sopor" style="width: 400px; position: relative; bottom: 10px;">
                ...
                <tr class="row-bl">
                    ...
                    <td id="ges">
                            ...
                            <option value="0">GESTION TECNICA EXTERNA</option>
                        </select>
                    </td>
                    <td id="ges2" style="display: none;">GESTION TECNICA EXTERNA</td>
                    <td id="est">
    ...
    <script src="../../../../Controller/security/FALLA/anti-cheat-falla8.js"></script>
