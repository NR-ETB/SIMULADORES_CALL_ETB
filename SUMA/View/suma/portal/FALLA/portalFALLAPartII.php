...
<body>
                            ...
                            <div class="body-items-inf">
                                <div class="content-soport-sop" id="con-sopo-inter">
                                        ...
                                        <div class='content-item-info'>
                                            ...
                                            <label>Falla Masiva:</label> <span>1</span> <i class='fa-solid fa-eye eye-color' onclick="btn_mas();"></i><br>
                                            </div>

                                            <div class='content-item-info'>
                                            <label>Visita Abierta:</label><br>
                                            <label>PQRs Falla Técnica:</label> <span>1</span> <i class='fa-solid fa-eye eye-color' onclick="btn_falla();"></i><br>
                                ...
                                <div class="con-table2">
                                    <table class="table-general table-sopor table-produc">
                                        ...
                                        <tbody>
                                            ...
                                            <td>Detalle</td>
                                            <td><i class='fa-solid fa-eye eye-color' onclick="location.href='./pqrFALLA.php'"></i></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
    ...
    <script src="../../../../Controller/security/FALLA/anti-cheat-falla5.js"></script>
