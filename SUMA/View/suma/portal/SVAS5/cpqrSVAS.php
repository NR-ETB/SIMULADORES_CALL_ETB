...
<div class="main-pqr"> 
            ...
            <div class="usuario" style="margin-left: 35px;">
                <div>
                    ...
                    <span>NATALIA FERNANDES</span>
                </div>
                <div>
                    <label for="">Cedula de Ciudadania</label>
                    <span>1000958632</span>
                </div>
                <div>
            ...
            <div class="usuario" style="margin-bottom: 100px; margin-left: 35px;">
                <div>
                    ...
                    <span style="color: #000;">6012065894</span>
                </div>
                <div>
                    <label for="">Cuenta de Facturacion:</label>
                    <span style="color: #000;">5555 </span>
                </div>
                <div>
                    ...
                    <script>
                        ...
                        <form>
                            ...
                            <select name="solicitante" id="search-soli" readonly="readonly" class="solicitante-search" style="background-color: #c0c0c0; width: 735px; margin-bottom: 20px;">
                                ...
                                <option id="cun-rel2" value="1" style="display: none;">NATALIA FERNANDES</option>
                            </select>
                        ...
                        <form style="position: relative; left: 800px; bottom: 1275px;">
                            ...
                            <label for="">CUN</label>
                                <span>
                                <img src="../../../images/speaker2.png" alt="parlante-audio-etb" class="img-audio" id="img_solicitante" onclick="alertAudio('au_solicitante2', 2, 5)">
                                <audio id="au_solicitante2" controls class="audio" style="display: none;">
                            ...
                            <input value="Crear" onclick="btn_fase();" class="crear-pqr">
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-gen2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="btn-modal-ps4error" style="left: 0;" onclick="btn_sig2();">VALIDAR CODIGO</button>
            </div>
        </div>
        </div>
    </div>

    <div class="modal modal-success-sim" tabindex="-1" id="modal-gen">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="mas">Información</h5>
            </div>
            <div class="modal-body">
                <div style="display: flex;">
                    <p>Finalizo el tiempo de espera para la validación. ¿Deseo continuar o generar un nuevo codigo?
                    </p>
                </div>
            </div>
            <div class="modal-footer" style="display: flex; position: relative; right: 160px;">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="habladorText('Cuando das click en esta opcion, al cliente se le reenviara un nuevo SMS, con el codigo alfanumerico.')">REENVIAR CODIGO</button>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="btn-modal-ps4error" onclick="gen2(),habladorText('Ingresa el Codigo ABCD444 en la casilla y acto seguido presiona en Validar')"">VALIDAR CODIGO</button>
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            <p>Has finalizado con exito el escenario OTP EN PQR del Simulador SUMA, recuerda que siempre esta a tu disposicion y cuentas con intentos ilimitados :)</p>
            </div>
            <div class="modal-footer">
    ...
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas10.js"></script>
