...
<body>
                                                        ...
                                                        <div class="con-table">
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Señal a ruido</td>
                                                                        <td id="sen1" class="info__sem">-<div class="semaforo semaforo-temp"></div></td>
                                                                        <td id="sen2" class="info__sem" style="display: none;">34.4<div class="semaforo semaforo-co"></div></td>
                                                                    </tr>
                                                                    <tr class="row-bl">
                                                                        <td>Atenuación</td>
                                                                        <td id="ate1" class="info__sem">-<div class="semaforo semaforo-temp"></div></td>
                                                                        <td id="ate2" class="info__sem" style="display: none;">15.3<div class="semaforo semaforo-co"></div></td>
                                                                    </tr>   
                                                                </tbody>
                                                            </table>
                                                        </div>
    ...
    <script src="../../../../Controller/security/FTTH5/anti-cheat-ftth7.js"></script>
