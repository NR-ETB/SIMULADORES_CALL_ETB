...
<div class="usuario" style="margin-left: 35px;">
            ...
            <div class="usuario" style="margin-left: 35px;">
                ...
                <div style="margin-left: 150px; display: flex;">
                    ...
                    <button class="pqr-b3" style="width: 25%; margin-left: 5px;" onclick="bus5();">Buscar</button>
            ...
            <table class="table-general table-sopor" style="width: 400px; position: relative; bottom: 10px; margin: 20px 0 0 60px;">
                ...
                <tr id="abi6" class="row-bl">
                    <td><div class="semaforo semaforo-co"></div></td>
                    <td>4</td>
                    <td>MDM-PQR-3939243</td>
                    <td>nnicrod</td>
                    <td>CLAID MUSS</td>
                    <td>12:06 19/8/2024</td>
                    <td>CERRADO</td>
                    <td></td>
                    <td>FALLA TECNICA</td>
                ...
                <tr id="df6" style="background-color: rgb(226 226 226); display: none; cursor: none;">
                    <td colspan="13">Numero Conexion: 6013215796485
                        <br>
                        Numero Pedido
                        <br>
                ...
                <tr id="abi7" class="row-bl" onclick="tabac13(),tabac14();">
                    <td><div class="semaforo semaforo-co"></div></td>
                    <td>0</td>
                ...
                <tr id="df7" style="background-color: rgb(226 226 226); display: none; cursor: none;">
                    <td colspan="13">Numero Conexion: 6013215796485
                        <br>
                        Numero Pedido
                        <br>
    ...
    <script src="../../../../Controller/security/FTTH5/anti-cheat-ftth.js"></script>
