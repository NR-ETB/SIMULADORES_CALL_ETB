...
<body>
            ...
            <div class="contedor-portal">
                <div class="breadcump">
                    ...
                    <div id="age" class="menus">
                        ...
                        <button onclick="btn_vis();" style="background-color: #084d6f;">PQR</button>
                           ...
                           <div class="table-product" id="con-sopo-inter">
                                <div class="con-table">
                                    <table class="table-general table-sopor table-produc">
                                        ...
                                        <tbody onclick="tabac1(),tabac2(),habladorText('Para realizar la gestion, primero deberas dirigirte al apartado de PQR, en el menu lateral derecho');">
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                <p>En el escenario de la LEY 2300 DE 2023 del simulador SUMA, hacer caso omiso a las siguientes indicaciones y aprende en el proceso</p>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-dates" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal modal-success-sim" tabindex="-1" id="modal-gen1">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="mas">CODIGO GENERADO</h5>
                </div>
                <div class="modal-body">
                <p>El codigo gererado es: 00004406912DA</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="btn-modal-ps4error" onclick="gen2(),habladorText('Se acaba de nerar tu codigo recuerda que es: 00004406912DA');">ACEPTAR</button>
                </div>
            </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div style="display: flex;">
                        <p style="color: var(--orange-etb);">Codigo Verificación</p><input type="text" placeholder="INGRESE CODIGO" style="height: 35px; margin-left: 25px;">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="btn-modal-ps4error" onclick="btn_fase();">ACEPTAR</button>
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="display: flex;">
                    ...
                    <button type="button" class="btn btn-secondary" id="btn-modal-ps4error" style="background-color: #20a4cb; border: none; border-radius: 20px; position: relative; left: 110px;" onclick="ley_def();">Registrar</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <h5 class="modal-title">PQR</h5>
                        <img src="../../../images/speaker2.png" alt="parlante-audio-etb" class="img-audio" id="img_editar_contac" onclick="alertAudio('au_editar_contac', 'img_editar_contac', 2, 7)">
                        <audio id="au_editar_contac" class="audio" style="display: none;">
                            <source type="audio/wav" src="../../../../Model/audioSuma/audio/tep/au_editar_contac.mp3">
                        </audio>
                    </h5>           
                </div>
                                ...
                                <div class="con-table2">
                                    <table class="table-general table-sopor table-produc">
                                        ...
                                        <tbody>
                                            ...
                                            <td>SOPORTE</td>
                                            <td>TRANSACCION</td>
                                            <td><i class='fa-solid fa-eye eye-color' onclick="deta();"></i></td>
                                            <td><div class='semaforo semaforo-error'></div></td>
                                            </tr>
                                        </tbody>
                                    </table>
    ...
    <div class="modal fade" id="modal-pqr2"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body">
                    ...
                    <div class="items-info items-sopor content-fact" id="df">
                        ...
                        <div class="body-items-inf">
                            <div class="content-fact-fac" id="con-sopo-inter" style="    display: grid; grid-gap: 20px; grid-template-columns: repeat(2, 1fr); grid-template-rows: repeat(3, 1fr);">

                                        <div class='content-item-info item-1'>
                                            <label>Usuario Creador:</label> <span>5555</span><br>
                                            <label>Reclamo:</label> <span>Activo</span><br>
                                            <label>Clase:</label> <span>PETICION</span><br>
                                            <label>Sistema Origen Reclamo:</label> <span>MDM</span><br>
                                            <label>Fecha Reclamo:</label> <span>10/08/2024 9:49:54 AM</span><br>
                                            <label>Modio Notificación:</label> <span>CORREO ELECTRONICO</span><br>
                                            <label>Número Conexión:</label> <span>6018001038</span><br>
                                            <label>Estado Reclamo:</label> <span>Cerrado</span><br>
                                            <label>Causal:</label> <span>FALLA INTERNET</span><br>
                                            <label>Fecha Agenda:</label> <span>2024-10-08</span><br>
                                            <label>Nombre Intalador:</label> <span>MARCO PEREZ CASAS</span><br>
                                            <label>Herencia:</label> <span>si</span><br>
                                            <label>Descripción Reclamo:</label> <span>ok</span><br>
                                            <label>Respuesta Reclamo:</label> <span>ok</span><br>
                                            <label>Zona:</label> <span>CHICO</span><br>
                                            <label>Proveedor</label> <span></span><br>
                                            <button class="btn btn-secondary" style="margin-bottom: 10px; background-color: #20a4cb; border-color: #20a4cb;" onclick="location.href='cpqrSVAS.php'">Detalle PQR</button>
                                        </div>

                                        <div class='content-item-info item-2'>
                                            <label>Tipo:</label> <span>FALLA TECNICA</span><br>
                                            <label>CUN:</label> <span>43471800008975123</span><br>
                                            <label>Cuenta Facturación:</label> <span>5555</span><br>
                                            <label>Fech Solución:</label> <span>08/11/2024 11:06 AM</span><br>
                                            <label>Medio Recepción:</label> <span>Mensual</span><br>
                                            <label>Servicio:</label> <span>Mensual</span><br>
                                            <label>Valor Reclamado:</label> <span>Mensual</span><br>
                                            <label>Sintoma:</label> <span>Mensual</span><br>
                                            <label>Franja Agenda:</label> <span>Mensual</span><br>
                                            <label>Estado Agenda:</label> <span>Mensual</span><br>
                                        </div>

                                        <div class='content-item-info item-3'>
                                            <label>Categortia:</label> <span>FALLA_JOVEN_FO</span><br>
                                            <label>Falla:</label> <span>FISICA</span><br>
                                        </div>
                            ...
                            <div class="modal-body">
                                ...
                                <script>
                                    ...
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        let datosFormulario = [{
                                            tipoDocumento: "CC",
                                            numeroDocumento: "1000958632",
                                            nombres: "NATIALA",
                                            apellidos: "FERNANDES",
                                            telefonoFijo: "6012065894",
                                            celular: "3195216852",
                                            email: "natf@email.com",
                                            direccion: "Calle 85A #23 c 28",
                                ...
                                <button style="background-color: #FF5E00;" class="btn_clasic" id="btn-solucion4" onclick="gen();">GENERAR CODIGO</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="items-info items-sopor content-fact" id="df-31" style="height: 140px; display: none;">
                        ...
                        <div class="body-items-inf">
                            <button style="position: relative; left: 240px; top: 8px; width: 220px;  background: #11A1D8; padding: 3px 5px; border: 2px solid transparent; color: #FFFFFF; margin-right: 15px;" onclick="ley_def();">Autorizacion Informacion Ley 2300</button>
                        </div>
                    </div>
    ...
    <script src="../../../../Controller/suma/SVAS/portalSVAS6.js"></script>
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas21.js"></script>
