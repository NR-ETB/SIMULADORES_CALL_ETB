...
<body>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header" id="header-cons">
                    <h5>CREANDO PQR: MDM-PQR-3939230
                ...
                <div class="modal-body">
                    ...
                    <div class="info-u info-repor">
                        ...
                        <select name="optagenda" id="ages4">
                            <option value="0">Selecione...</option>
                            <option value="1" style="background-color: rgb(192, 192, 192);">BAJA CALIDAD DEL SERVICIO</option>
                        ...
                        <select name="optagenda" id="ages5">
                            ...
                            <option value="2" style="background-color: rgb(192, 192, 192);">INTERMITENCIA -F</option>
                        </select><span style="color: red; position: relative; left: 275px; bottom: 40px;">*</span>
            
                        <label for="" class="label">CUN</label>
                        <select name="optagenda" class="label2" id="label2">
                            <option id="cun-no-rel" value="0"></option>
                            <option id="cun-rel" value="1" style="display: none; background-color: #c0c0c0;">4347240001063766</option>
                        </select>
                            ...
                            <!-- Items -->
                                    ...
                                    <img src="../../../images/bolsa-de-la-compra2.png" alt="">
                                        ...
                                        <div style="overflow-y: scroll; max-height: 50%; height: 1050px;">
                                            ...
                                            <!-- modal loading eterno -->
                                            <div class="modal fade modal-loading" tabindex="-1" id="modal-loading2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                ...
                                                                <table class="table-general table-sopor">
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="row-bl">
                                                                            ...
                                                                            <td>300M</td>
                                                                            <td class="info__sem">300M <div class="semaforo semaforo-temp"></div></td>
                                                                        </tr>
                                                                        <tr>
                                                                ...
                                                                <table class="table-general table-sopor">
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="row-bl">
                                                                            <td>Velocidad Bajada</td>
                                                                            <td>300M</td>
                                                                            <td class="dell-sem" id="internet1">300M<div class="semaforo semaforo-error"></div></td>
                                                                            <td class="dell-sem" id="internet2" style="display: none;">300M<div class="semaforo semaforo-co"></div></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>Velocidad Subida</td>
                                                                            <td>300M</td>
                                                                            <td class="dell-sem" id="internet3">#NOTFOUNDBO#<div class="semaforo semaforo-error"></div></td>
                                                                            <td class="dell-sem" id="internet4" style="display: none;">300M<div class="semaforo semaforo-co"></div></td>
                                                                        </tr>
                                                                        ...
                                                                        <tr class="row-bl">
                                                                            <td>DHCP Estado</td>
                                                                            <td>-</td>
                                                                            <td id="internet5" class="dell-sem">#NOTFOUNDBO#<div class="semaforo semaforo-error"></div></td>
                                                                            <td id="internet6" class="dell-sem" style="display: none;">-<div class="semaforo semaforo-co"></div></td>
                                                                        </tr>
    ...
    <script src="../../../../Controller/security/FTTHNO/anti-cheat-ftthno5.js"></script>
