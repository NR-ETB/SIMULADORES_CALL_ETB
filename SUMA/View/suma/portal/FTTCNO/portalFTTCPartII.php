...
<body>
                    ...
                    <div class="items-info items-sopor item-datas">
                        ...
                        <div class="body-items-inf" style="height: 330px;">
                            <div class="content-info" id="con-sopo-inter">
                                                ...
                                                <label>Nombre:</label> <span>ARMANDO PAREDES</span><br>
                                                <label>Tipo de Documento:</label> <span>CC</span><br>
                                                <label>Numero de Documento:</label> <span>1000652458</span><br>
                                                <label>Email:</label> <span>arpa@email.com</span><br>
                                                <label>Telefono Fijo:</label> <span>60120354851</span><br>
                                                <label>Usuario MiETB:</label> <span>arpa@email.com</span><br>
                                                ...
                                                <label>Celular:</label> <span>3145216985</span><br>
                                                <label>Departamento:</label> <span>BOGOTA</span><br>
                                                <label>Ciudad:</label> <span>BOGOTA D.C</span><br>
                                                <label>Direccion:</label> <span>Calle 3A #41 c 36</span><br>
                           ...
                           <div class="table-product" id="con-sopo-inter">
                                <div class="con-table">
                                    <table class="table-general table-sopor table-produc">
                                        ...
                                        <td>60120354851</td>
                                        <td>1111</td>
                                        <td>KR 69D 24A 78 IN 2 AP 404</td>
                                        <td>4</td>
                                        <td>FTTC</td>
                                        <td></td>
                                        <td>Activo</td>
                            ...
                            <div class="body-items-inf">
                                <div class="content-soport-sop" id="con-sopo-inter">
                                        ...
                                        <div class='content-item-info'>
                                            ...
                                            <label>Equipo:</label> <span>BOSIHU60T04003</span><br>
                        ...
                        <div class="items-info items-sopor content-fact" id="df">
                            ...
                            <div class="body-items-inf">
                                <div class="content-fact-fac" id="con-sopo-inter">
                                            ...
                                            <label>Cuenta Facturacion:</label> <span>11111111111</span><br>
                                            <label>Estado Cta Facturacion:</label> <span>Activo</span><br>
                                            <label>Ciclo:</label> <span>54</span><br>
                                            <label>Dirección Facturación:</label> <span>Calle 3A #41 c 36</span><br>
                                            ...
                                            <label>Email Facturación:</label> <span>arpa@email.com</span><br>
                                            ...
                                            <label>Departamento:</label> <span>Bogota</span><br>
                                            <label>Ciudad:</label> <span>Bogota D.C</span><br>
                                            <label>Barrio:</label> <span>001105</span><br>
                                ...
                                <div class="con-table2">
                                    <table class="table-general table-sopor table-produc">
                                        ...
                                        <tr id="abi3" onclick="tabac5(),tabac6();">
                                            ...
                                            <td><script>document.write(`${day}/${month}/${year}`)</script> <script>document.write(`${hours}:${minutes}`)</script></td>
                                            <td>INTERNET</td>
                                            <td>FALLA INTERNET</td>
                                            <td>NO CONECTA/NO NAVEGA -F</td>
                                            <td>ABIERTO</td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            ...
                                            <td>Detalle</td>
                                            <td><i class='fa-solid fa-eye eye-color' onclick="location.href='./pqrFTTH.php'"></i></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                        ...
                        <div class="items-info items-sopor item-datas" id="table1" style="height: 350px; bottom: 160px; margin: 80px 0 0 0;">
                            ...
                            <div class="body-items-inf">
                                <div class="content-info" id="con-sopo-inter">
                                    ...
                                    <div class='content-item-info item-1'>
                                    <br>
                                    <label>Cuenta de Facturación</label> <span>1111</span><br>
                                    <br><br>
                                    <label>Ciudad Instalación</label> <span>Bogota D.C</span><br>
                                    ...
                                    <div class='content-item-info item-2'>
                                    <label>Direccion Instalación</label> <span>Calle 3A #41 c 36</span><br><br>
                                    ...
                                    <label>Departamento Instalación</label> <span>BOGOTA D.C</span><br>
                                    <label>Zona Instalación</label> <span></span><br>
                                    <label>Tecnologia</label> <span>FTTC</span><br>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            <p>Has finalizado con exito el escenario NO CONECTA/NO NAVEGA (FTTC) del Simulador SUMA, recuerda que siempre esta a tu disposicion y cuentas con intentos ilimitados :)</p>
            </div>
            <div class="modal-footer">
    ...
    <script src="../../../../Controller/security/FTTC/anti-cheat-fttc4.js"></script>

    <script>
        habladorText('Dirigete al apartado de PQRs Falla Tecnica, para esto da click en el icono del ojo')
    </script>
