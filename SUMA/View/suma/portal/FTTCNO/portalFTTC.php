...
<body>
                            ...
                            <div class="body-items-inf">
                                <div class="content-soport-sop" id="con-sopo-inter">
                                        ...
                                        <div class='content-item-info'>
                                            ...
                                            <label>Reportar Falla:</label> <span></span> <i class='fa-solid fa-eye eye-color'  onclick="btn_report();"></i><br>
                                        </div>   
                        ...
                        <div class="items-info items-sopor content-fact" id="df" style="display: none;">
                            ...
                            <div class="body-items-inf">
                                <div class="content-fact-fac" id="con-sopo-inter">
                                            ...
                                            <label>Cuenta Facturacion:</label> <span>1111</span><br>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="dates(),habladorText('Cliente: ARMANDO PAREDES <br> Numero de Documento: CC 1000652458 <br> Numero de Conexion: 60120354851 <br> Cuenta Facturacion: 1111');">ACEPTAR</button>
                </div>
            </div>
            </div>
    </div>
    ...
    <script src="../../../../Controller/security/FTTCNO/anti-cheat-fttcno3.js"></script>
