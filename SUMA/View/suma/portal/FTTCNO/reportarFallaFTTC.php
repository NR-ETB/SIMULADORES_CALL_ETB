...
<body>
    ...
    <div class="container-genre">
        ...
        <!-- No Solucionado, modal general e inmersivo -->
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header" id="header-cons">
                    <h5>CREANDO PQR: MDM-PQR-3939224
                        <img src="../../../images/speaker.png" alt="parlante-audio-etb" class="img-audio" id="img_info_sf" onclick="alertAudio('au_info_sf4', 'img_info_sf', 1, 1)">
                        <audio id="au_info_sf4" controls class="audio" style="display: none;">
                            <source type="audio/wav" src="../../../../Model/audioSuma/audio/soporte/gcs20.mp3">
                        </audio>
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="info-u info-repor">
                        ...
                        <select name="optagenda" id="ages4">
                            ...
                            <option value="3" style="background-color: rgb(192, 192, 192);">FALLA INTERNET</option>
                        ...
                        <select name="optagenda" id="ages5">
                            ...
                            <option value="2" style="background-color: rgb(192, 192, 192);">NO CONECTA/NO NAVEGA -F</option>
                        </select><span style="color: red; position: relative; left: 275px; bottom: 40px;">*</span>
            
                        <label for="" class="label">CUN</label>
                        <select name="optagenda" class="label2" id="label2">
                            <option id="cun-no-rel" value="0"></option>
                            <option id="cun-rel" value="1" style="display: none; background-color: #c0c0c0;">4347240001063765</option>
                        </select>
                        ...
                        <script>
                            ...
                            document.addEventListener("DOMContentLoaded", function() {
                                ...
                                let datosFormulario = [{
                                    ...
                                    nombres: "ARMANDO",
                                    apellidos: "PAREDES",
                                    telefonoFijo: "20354851",
                                    celular: "6013145216985",
                                    email: "arpa@email.com",
                                    direccion: "Calle 3A #41 c 36",
                        ...
                        <button class="btn_clasic" id="btn-solucion2" onclick="btn_solucion2();">Guardar</button>
                </div>
              </div>
            </div>
        </div>

        <!-- No Solucionado, formulario del solicitante -->
        ...
        <!-- No Solucionado, paso calendar final -->
        <div class="modal fade" id="modal-soluic4" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
            ...
            <div class="items-info" id="aten-4">
                ...
                <div style="display: grid; justify-content: center;">    
                    ...
                    <div id="no-ven" style="display: -webkit-inline-box; margin-top: 50px; position: relative; left: 330px;">
                        <img src="../../../images/speaker2.png" alt="parlante-audio-etb" class="img-audio" id="img_info_sf" onclick="alertAudio('au_info_sf4', 'img_info_sf', 1, 1)">
                        <audio id="au_info_sf4" controls class="audio" style="display: none;">
                            <source type="audio/wav" src="../../../../Model/audioSuma/audio/soporte/gcs20.mp3">
                        </audio>
                            ...
                            <div class="modal-content" id="modal-soluic" style="width: 100%; position: relative; bottom: 20px; left: 0; display: none;">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="info-u">
                                        <label for="">Cliente</label>
                                        <label for="">Número de Documento</label>
                                        <p id="nomCli">ARMANDO PAREDES</p>
                                        <p id="docCli">1000652458</p> 
                                    </div>
                                ...
                                <div style="overflow-y: scroll; max-height: 50%; height: 1050px;">
                                    ...
                                    <div class="soportepn">
                                                ...
                                                <div class="contet hide-body con-tree-colms" id="con-sopo-infro">
                                                    ...
                                                    <div class="con-table">
                                                        <table class="table-general table-sopor">
                                                            ...
                                                            <tr class="row-bl">
                                                                <td>Estado Modem</td>
                                                                <td class="dell-sem">Active <div class="semaforo semaforo-co"></div></td>
                                                            </tr>

                                                            <tr>
                                                                <td>Señal a ruido</td>
                                                                <td class="dell-sem">5.9 <div class="semaforo semaforo-error"></div></td>
                                                            </tr>

                                                            <tr class="row-bl">
                                                                <td>Atenuacion</td>
                                                                <td class="dell-sem">4.8 <div class="semaforo semaforo-co"></div></td>
                                                            </tr>
                                                        ...
                                                        <table class="table-general table-sopor">
                                                            ...
                                                            <tbody>
                                                                <tr class="row-bl">
                                                                    <td>Serial</td>
                                                                    <td>ZTE</td>
                                                                    <td class="info__sem"><div class="semaforo semaforo-co"></div></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                            ...
                                            <div class="cabecera">
                                                <h5 onclick="itemInfoSoporte('con-sopo-inter')">
                                                    ...
                                                    <audio id="au_it_sf" controls class="audio" style="display: none;">
                                                        <source type="audio/wav" src="../../../../Model/soporte/au_it_sf.wav">
                                                    </audio>
                                            </div>
                                            <div class="body-items-inf">
                                                <div class="contet hide-body con-tree-colms" id="con-sopo-inter">
                                                    <div class="con-cards-soporte" style="grid-column: 1/4;">
                                                        ...
                                                        <div class="cards-soporte">
                                                            <h2>ID servicio MSS</h2>
                                                            <p>SR-25246038</p>
                                                        </div>
                    
                                                        <div class="cards-soporte">
                                                            <h2>Modelo CPE-DSL</h2>
                                                            <p>ZXHN H222M</p>
                                                        </div>
                                                        ...
                                                        <table class="table-general table-sopor">
                                                            ...
                                                            <tbody>
                                                                <tr class="row-bl">
                                                                    <td>Velocidad Bajada</td>
                                                                    <td>30M</td>
                                                                    <td class="dell-sem">30M<div class="semaforo semaforo-co"></div></td>
                                                                </tr>
                                                ...
                                                <div class="contet hide-body con-tree-colms" id="con-sopo-ajustes-wifi">
                                                    ...
                                                    <div class="con-table">
                                                        <table class="table-general table-sopor">
                                                            ...
                                                            <tbody>
                                                                <tr class="row-bl">
                                                                    <td>Estado WIFI</td>
                                                                    <td class="dell-sem"><span id="estado-red">Inactivo</span> <div id="sem2" class='semaforo semaforo-error'></div></td>
                                                                </tr>
                                                    ...
                                                    <div class="items-actions-soporte items__actions_four" style="border-top: 0px;">
                                                        ...
                                                        <div class="dropdrown-act drowndown__fon" id="dropdrown-act-ont">
                                                            ...
                                                            <label for="" id="change-norm-wifi2" onclick="habladorText('Permite cambiar el canal por el cual esta trabajando el WIFI a 2.4ghz');">Normalizar Canal</label>
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    <tr class="row-bl">
                                                                        ...
                                                                        <td class="dell-sem"><span id="estado-red5">Inactivo</span><div id="sem5" class="semaforo semaforo-error"></div></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Canal (5.0)</td>
                                                        ...
                                                        <table class="table-general table-sopor">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>+576017647268</td>
                                                                    <td class="dell-sem">+576017647268 <div class="semaforo semaforo-co" id="semaforo-tel-modem"></div></td>
                                                                </tr>
                                                        ...
                                                        <table class="table-general table-sopor">
                                                            ...
                                                            <tbody>
                                                                <tr class="row-bl">
                                                                    <td>Estado</td>
                                                                    <td>Activo</td>
                                                                    <td class="dell-sem"><span id="estado-tv">Suspendida</span><div class="semaforo semaforo-co" id="semaforo-estado-tv"></div></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Plan</td>
                                                                    <td>PLAN BASICO</td>
                                        ...
                                        <div class="con-dos-btn-retor">
                                            <button id="no" class="btn_clasic btn_orage_bg" onclick="modalnoso()">No Solucionado</button>
                                            <button id="no2" class="btn_clasic btn_orage_bg" onclick="no2()" style="display: none;">No Solucionado</button>
                                            <button class="btn_clasic">Solucionado</button>
                                        </div>
        ...
        <div class="modal fade modales-soporte" tabindex="-1" id="modal-exito-solucionado4" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="false">
                <div class="modal-dialog modal-dialog-centered modal-dialog-exito-s">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"><span id="tittle-main-exit-s">ACTUALIZACIÓN DE LA VISITA</span><span id="titulo-alerta-corr-s"></span></h5>
                        ...
                        <div class="modal-footer">
                            <button type="button" id="btn_exito" onclick="modalExitoSoporteSolucionado2();">Aceptar</button>
                        </div>
                    </div>
                </div>
        </div>
                        ...
                        <div class="items-info items-sopor" id="ite2">
                            <div class="cabecera">
                                <h5>
                                    <img src="../../../images/rule.svg" alt="" class="menus-cabecera">
                                    Reaprovisionar</h5>
                                <img src="../../../images/speaker2.png" alt="parlante-audio-etb" class="img-audio" id="img_info_sf" onclick="alertAudio('au_info_sf3', 'img_info_sf', 1, 1)">
                                <audio id="au_info_sf3" controls class="audio" style="display: none;">
                                    <source type="audio/wav" src="../../../../Model/audioSuma/audio/soporte/au_info_sf3.mp3">
                                </audio>
                            </div>
        ...
        <div class="modal modal-success-sim" tabindex="-1" id="modal-info-soluci2" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="btn-fa" onclick="agen0();">ACEPTAR</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal modal-success-sim" tabindex="-1" id="modal-ace2" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">INFORMACIÓN</h5>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="btn_sig3()">ACEPTAR</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade modales-soporte" tabindex="-1" id="modal-exito-solucionado44" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="false" style="left: -230px; top: -100px;">
            ...
            <!-- Modal flujo -->
            <div class="modal fade" id="modal-flujo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="margin-top: 50px;">
                <div class="modal-dialog" id="modal-dialog-flujo">
                <div class="modal-content">
                    <div class="modal-header" id="btn-close-flujo" onclick="btn_flujoheader();">
                    ...
                    <div class="modal-body">
                    <iframe src="https://etb--devflow.sandbox.my.salesforce-sites.com/FTTC" frameborder="0" class="recomendador"></iframe>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="modal fade modales-soporte" tabindex="-1" id="modal-nor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="false">
                <div class="modal-dialog modal-dialog-centered modal-dialog-exito-s">
                    <div class="modal-content" style="position: relative; bottom: 350px;">
                        <div class="modal-header">
                            <h5 class="modal-title"><span id="tittle-main-exit-s">ACTUALIZACIÓN DE LA VISITA</span><span id="titulo-alerta-corr-s"></span></h5>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" data-bs-dismiss="modal" id="btn-modal-ps4error">Aceptar</button>
                        </div>
                    </div>
                </div>
            </div>

            <div class="modal fade modales-soporte" tabindex="-1" id="modal-solu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="false">
                <div class="modal-dialog modal-dialog-centered modal-dialog-exito-s">
                    <div class="modal-content" style="position: relative; bottom: 350px;">
                        <div class="modal-header">
                            <h5 class="modal-title"><span id="tittle-main-exit-s">ACTUALIZACIÓN DE LA VISITA</span><span id="titulo-alerta-corr-s"></span></h5>
                        ...
                        <div class="modal-footer">
                            <button type="button" data-bs-dismiss="modal" onclick="solu();">Aceptar</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal modal-success-sim" tabindex="-1" id="modal-fase1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <p>Has finalizado con exito la FALLA FTTC del simulador S.U.M.A, recuerda que siempre esta a tu disposicion y cuentas con intentos ilimitados :)</p>
                    </div>
                    <div class="modal-footer">
    ...
    <script src="../../../../Controller/suma/FTTC/soporteFTTC.js"></script>
    <script src="../../../../Controller/security/FTTCNO/anti-cheat-fttcno6.js"></script>
