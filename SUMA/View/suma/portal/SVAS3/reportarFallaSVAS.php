...
<body>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header" id="header-cons">
                    <h5>CREANDO PQR: MDM-PQR-3939240</h5>
                                                            ...
                                                            <table class="table-general table-sopor">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="row-bl">
                                                                        <td>Serial</td>
                                                                        <td>ZTEGD0348FB8</td>
                                                                        <td class="dell-sem">-<div class="semaforo semaforo-temp"></div></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Mac</td>
                                                                        <td>7426FFESE7EE</td>
    ...
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas6.js"></script>
