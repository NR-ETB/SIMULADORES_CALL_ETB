...
<body>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                <p>En el escenario de INFRAESTRUCTURA DE ACCESO (MODEM CON SEMAFOROS AMARILLOS) del simulador SUMA, hacer caso omiso a las siguientes indicaciones y aprende en el proceso</p>
                </div>
                <div class="modal-footer">
    ...
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas5.js"></script>
