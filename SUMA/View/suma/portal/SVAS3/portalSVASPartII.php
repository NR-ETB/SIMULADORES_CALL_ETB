...
<body>
    ...
    <div class="modal modal-success-sim" tabindex="-1" id="modal-fase1">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <p>Has finalizado con exito el escenario INFRAESTRUCTURA DE ACCESO 1 del Simulador SUMA, recuerda que siempre esta a tu disposicion y cuentas con intentos ilimitados :)</p>
                </div>
                <div class="modal-footer">
    ...
    <script src="../../../../Controller/security/SVAS/anti-cheat-svas19.js"></script>
